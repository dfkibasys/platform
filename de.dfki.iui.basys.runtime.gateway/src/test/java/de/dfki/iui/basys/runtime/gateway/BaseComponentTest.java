...
public class BaseComponentTest {
	...
	protected static ComponentConfiguration config1, config2, config3, registryConfig, observerConfig, managerConfig, jmsGatewayConfig, mqttGatewayConfig; 
	...
	public static void setUpBeforeClass() throws Exception {
		...
		jmsGatewayConfig = new ComponentConfigurationImpl.Builder()
				...
				.externalConnectionString(communicationProviderConnectionString)
				.build();		
		
		mqttGatewayConfig = new ComponentConfigurationImpl.Builder()
