...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.aas.AdministrationShell} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AdministrationShellItemProvider extends EntityItemProvider {
	 ...
	 * @generated
	 */
	public AdministrationShellItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_AdministrationShell_assetId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_AdministrationShell_assetId_feature", "_UI_AdministrationShell_type"),
				 AasPackage.Literals.ADMINISTRATION_SHELL__ASSET_ID,
				 true,
				 false,
				 false,
	...
	/**
	 * This returns AdministrationShell.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AdministrationShell"));
	}
	...
	public String getText(Object object) {
		String label = ((AdministrationShell)object).getId();
		return label == null || label.length() == 0 ?
			getString("_UI_AdministrationShell_type") :
			getString("_UI_AdministrationShell_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(AdministrationShell.class)) {
