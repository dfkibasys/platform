 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.ProductInstanceImpl#getProductVariantId <em>Product Variant Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.ProductInstanceImpl#getOrderId <em>Order Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.ProductInstanceImpl#getSerialNumber <em>Serial Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductInstanceImpl extends IdentifiableEntityImpl implements ProductInstance {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.PRODUCT_INSTANCE;
	}
	...
	public void setProductVariantId(String newProductVariantId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.PRODUCT_INSTANCE__PRODUCT_VARIANT_ID, oldProductVariantId, productVariantId));
	}
	...
	public void setOrderId(String newOrderId) {
		...
		orderId = newOrderId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.PRODUCT_INSTANCE__ORDER_ID, oldOrderId, orderId));
	}
	...
	public void setSerialNumber(String newSerialNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.PRODUCT_INSTANCE__SERIAL_NUMBER, oldSerialNumber, serialNumber));
	}
