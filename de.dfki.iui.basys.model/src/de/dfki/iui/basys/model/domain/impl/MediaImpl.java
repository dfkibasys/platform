 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.MediaImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.MediaImpl#getFileSize <em>File Size</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.MediaImpl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.MediaImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.MediaImpl#getEntityType <em>Entity Type</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.MediaImpl#getEntityIds <em>Entity Ids</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.MediaImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.MediaImpl#getLocale <em>Locale</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MediaImpl extends IdentifiableEntityImpl implements Media {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.MEDIA;
	}
	...
	public void setType(String newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MEDIA__TYPE, oldType, type));
	}
	...
	public void setFileSize(int newFileSize) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MEDIA__FILE_SIZE, oldFileSize, fileSize));
	}
	...
	public void setChecksum(String newChecksum) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MEDIA__CHECKSUM, oldChecksum, checksum));
	}
	...
	public void setLocation(String newLocation) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MEDIA__LOCATION, oldLocation, location));
	}
	...
	public void setEntityType(String newEntityType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MEDIA__ENTITY_TYPE, oldEntityType, entityType));
	}
	...
	public EList<String> getEntityIds() {
		if (entityIds == null) {
			entityIds = new EDataTypeUniqueEList<String>(String.class, this, DomainPackage.MEDIA__ENTITY_IDS);
		}
		return entityIds;
	}
	...
	public EList<String> getTags() {
		if (tags == null) {
			tags = new EDataTypeUniqueEList<String>(String.class, this, DomainPackage.MEDIA__TAGS);
		}
		return tags;
	}
	...
	public void setLocale(String newLocale) {
		...
		locale = newLocale;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MEDIA__LOCALE, oldLocale, locale));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.MEDIA__TYPE:
				return getType();
			case DomainPackage.MEDIA__FILE_SIZE:
				return getFileSize();
			case DomainPackage.MEDIA__CHECKSUM:
				return getChecksum();
			case DomainPackage.MEDIA__LOCATION:
				return getLocation();
			case DomainPackage.MEDIA__ENTITY_TYPE:
				return getEntityType();
			case DomainPackage.MEDIA__ENTITY_IDS:
				return getEntityIds();
			case DomainPackage.MEDIA__TAGS:
				return getTags();
			case DomainPackage.MEDIA__LOCALE:
				return getLocale();
		}
