 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.ProductInstanceStatusImpl#getProductInstanceId <em>Product Instance Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.ProductInstanceStatusImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.ProductInstanceStatusImpl#getWorkstepInstanceId <em>Workstep Instance Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductInstanceStatusImpl extends EntityImpl implements ProductInstanceStatus {
	 ...
	 * @ordered
	 */
	protected static final ProductInstanceStatusEnum STATUS_EDEFAULT = ProductInstanceStatusEnum.IN_PRODUCTION;
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.PRODUCT_INSTANCE_STATUS;
	}
	...
	public void setProductInstanceId(String newProductInstanceId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.PRODUCT_INSTANCE_STATUS__PRODUCT_INSTANCE_ID, oldProductInstanceId, productInstanceId));
	}
	...
	public void setStatus(ProductInstanceStatusEnum newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.PRODUCT_INSTANCE_STATUS__STATUS, oldStatus, status));
	}
	...
	public void setWorkstepInstanceId(String newWorkstepInstanceId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.PRODUCT_INSTANCE_STATUS__WORKSTEP_INSTANCE_ID, oldWorkstepInstanceId, workstepInstanceId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.PRODUCT_INSTANCE_STATUS__PRODUCT_INSTANCE_ID:
				return getProductInstanceId();
			case DomainPackage.PRODUCT_INSTANCE_STATUS__STATUS:
				return getStatus();
			case DomainPackage.PRODUCT_INSTANCE_STATUS__WORKSTEP_INSTANCE_ID:
