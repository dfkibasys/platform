...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Staff Skill</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.StaffSkillImpl#getWorkstepId <em>Workstep Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.StaffSkillImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.StaffSkillImpl#getPreference <em>Preference</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StaffSkillImpl extends MinimalEObjectImpl.Container implements StaffSkill {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.STAFF_SKILL;
	}
	...
	public void setWorkstepId(String newWorkstepId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.STAFF_SKILL__WORKSTEP_ID, oldWorkstepId, workstepId));
	}
	...
	public void setLevel(int newLevel) {
		...
		level = newLevel;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.STAFF_SKILL__LEVEL, oldLevel, level));
	}
	...
	public void setPreference(PreferenceEnum newPreference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.STAFF_SKILL__PREFERENCE, oldPreference, preference));
	}
