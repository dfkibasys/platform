 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.OrderStatusImpl#getOrderId <em>Order Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.OrderStatusImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.OrderStatusImpl#getPieceCount <em>Piece Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrderStatusImpl extends EntityImpl implements OrderStatus {
	 ...
	 * @ordered
	 */
	protected static final OrderStatusEnum STATUS_EDEFAULT = OrderStatusEnum.PLANNED;
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.ORDER_STATUS;
	}
	...
	public void setOrderId(String newOrderId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.ORDER_STATUS__ORDER_ID, oldOrderId, orderId));
	}
	...
	public void setStatus(OrderStatusEnum newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.ORDER_STATUS__STATUS, oldStatus, status));
	}
	...
	public void setPieceCount(int newPieceCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.ORDER_STATUS__PIECE_COUNT, oldPieceCount, pieceCount));
	}
