 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.MaterialImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MaterialImpl extends IdentifiableEntityImpl implements Material {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.MATERIAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.MATERIAL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.MATERIAL__NAME:
				return getName();
		}
