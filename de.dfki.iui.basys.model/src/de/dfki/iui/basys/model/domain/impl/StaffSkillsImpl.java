...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Staff Skills</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.StaffSkillsImpl#getWorkerId <em>Worker Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.StaffSkillsImpl#getSkills <em>Skills</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StaffSkillsImpl extends EntityImpl implements StaffSkills {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.STAFF_SKILLS;
	}
	...
	public void setWorkerId(String newWorkerId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.STAFF_SKILLS__WORKER_ID, oldWorkerId, workerId));
	}
	...
	public EList<StaffSkill> getSkills() {
		if (skills == null) {
			skills = new EObjectContainmentEList<StaffSkill>(StaffSkill.class, this, DomainPackage.STAFF_SKILLS__SKILLS);
		}
		return skills;
	}
