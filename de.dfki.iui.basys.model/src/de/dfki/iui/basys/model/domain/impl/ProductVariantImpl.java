 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.ProductVariantImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.impl.ProductVariantImpl#getProductGroupId <em>Product Group Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductVariantImpl extends IdentifiableEntityImpl implements ProductVariant {
	...
	protected EClass eStaticClass() {
		return DomainPackage.Literals.PRODUCT_VARIANT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.PRODUCT_VARIANT__NAME, oldName, name));
	}
	...
	public void setProductGroupId(String newProductGroupId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, DomainPackage.PRODUCT_VARIANT__PRODUCT_GROUP_ID, oldProductGroupId, productGroupId));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case DomainPackage.PRODUCT_VARIANT__NAME:
				return getName();
			case DomainPackage.PRODUCT_VARIANT__PRODUCT_GROUP_ID:
