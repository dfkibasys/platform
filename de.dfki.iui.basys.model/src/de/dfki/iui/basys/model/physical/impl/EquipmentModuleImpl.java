 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.physical.impl.EquipmentModuleImpl#getControlModules <em>Control Modules</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.physical.impl.EquipmentModuleImpl#getEquipmentModules <em>Equipment Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EquipmentModuleImpl extends IdentifiableEntityImpl implements EquipmentModule {
	/**
	...
	protected EClass eStaticClass() {
		return PhysicalPackage.Literals.EQUIPMENT_MODULE;
	}
	...
	public EList<ControlModule> getControlModules() {
		if (controlModules == null) {
			controlModules = new EObjectContainmentEList<ControlModule>(ControlModule.class, this, PhysicalPackage.EQUIPMENT_MODULE__CONTROL_MODULES);
		}
	...
	public EList<EquipmentModule> getEquipmentModules() {
		if (equipmentModules == null) {
			equipmentModules = new EObjectContainmentEList<EquipmentModule>(EquipmentModule.class, this, PhysicalPackage.EQUIPMENT_MODULE__EQUIPMENT_MODULES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PhysicalPackage.EQUIPMENT_MODULE__CONTROL_MODULES:
				return ((InternalEList<?>)getControlModules()).basicRemove(otherEnd, msgs);
			case PhysicalPackage.EQUIPMENT_MODULE__EQUIPMENT_MODULES:
