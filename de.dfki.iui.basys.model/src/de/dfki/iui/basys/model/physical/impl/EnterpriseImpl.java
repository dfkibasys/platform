 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.physical.impl.EnterpriseImpl#getSites <em>Sites</em>}</li>
 * </ul>
 *
 * @generated
 */
public class EnterpriseImpl extends IdentifiableEntityImpl implements Enterprise {
	/**
	...
	protected EClass eStaticClass() {
		return PhysicalPackage.Literals.ENTERPRISE;
	}
	...
	public EList<Site> getSites() {
		if (sites == null) {
			sites = new EObjectContainmentEList<Site>(Site.class, this, PhysicalPackage.ENTERPRISE__SITES);
		}
		return sites;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PhysicalPackage.ENTERPRISE__SITES:
