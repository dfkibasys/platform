 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.physical.impl.StorageUnitImpl#getEquipmentModules <em>Equipment Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StorageUnitImpl extends IdentifiableEntityImpl implements StorageUnit {
	...
	protected EClass eStaticClass() {
		return PhysicalPackage.Literals.STORAGE_UNIT;
	}
	...
	public EList<EquipmentModule> getEquipmentModules() {
		if (equipmentModules == null) {
			equipmentModules = new EObjectContainmentEList<EquipmentModule>(EquipmentModule.class, this, PhysicalPackage.STORAGE_UNIT__EQUIPMENT_MODULES);
		}
