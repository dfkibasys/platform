 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.physical.impl.ProcessCellImpl#getUnits <em>Units</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProcessCellImpl extends IdentifiableEntityImpl implements ProcessCell {
	...
	protected EClass eStaticClass() {
		return PhysicalPackage.Literals.PROCESS_CELL;
	}
	...
	public EList<Unit> getUnits() {
		if (units == null) {
			units = new EObjectContainmentEList<Unit>(Unit.class, this, PhysicalPackage.PROCESS_CELL__UNITS);
		}
		return units;
	}
