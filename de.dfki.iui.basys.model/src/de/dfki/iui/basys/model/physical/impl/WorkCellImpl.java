 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.physical.impl.WorkCellImpl#getEquipmentModules <em>Equipment Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkCellImpl extends IdentifiableEntityImpl implements WorkCell {
	...
	protected EClass eStaticClass() {
		return PhysicalPackage.Literals.WORK_CELL;
	}
	...
	public EList<EquipmentModule> getEquipmentModules() {
		if (equipmentModules == null) {
			equipmentModules = new EObjectContainmentEList<EquipmentModule>(EquipmentModule.class, this, PhysicalPackage.WORK_CELL__EQUIPMENT_MODULES);
		}
