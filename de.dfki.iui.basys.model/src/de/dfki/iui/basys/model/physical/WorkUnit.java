 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.physical.WorkUnit#getEquipmentModules <em>Equipment Modules</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.basys.model.physical.PhysicalPackage#getWorkUnit()
...
public interface WorkUnit extends IdentifiableEntity {
	 ...
	 * @see de.dfki.iui.basys.model.physical.PhysicalPackage#getWorkUnit_EquipmentModules()
