 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.physical.impl.ControlModuleImpl#getControlModules <em>Control Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ControlModuleImpl extends IdentifiableEntityImpl implements ControlModule {
	/**
	...
	protected EClass eStaticClass() {
		return PhysicalPackage.Literals.CONTROL_MODULE;
	}
	...
	public EList<ControlModule> getControlModules() {
		if (controlModules == null) {
			controlModules = new EObjectContainmentEList<ControlModule>(ControlModule.class, this, PhysicalPackage.CONTROL_MODULE__CONTROL_MODULES);
		}
