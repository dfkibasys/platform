 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.physical.impl.SiteImpl#getAreas <em>Areas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiteImpl extends IdentifiableEntityImpl implements Site {
	...
	protected EClass eStaticClass() {
		return PhysicalPackage.Literals.SITE;
	}
	...
	public EList<Area> getAreas() {
		if (areas == null) {
			areas = new EObjectContainmentEList<Area>(Area.class, this, PhysicalPackage.SITE__AREAS);
		}
		return areas;
	}
