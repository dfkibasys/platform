 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.roletopology.impl.WorkCellImpl#getStations <em>Stations</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkCellImpl extends WorkUnitImpl implements WorkCell {
	...
	protected EClass eStaticClass() {
		return RoletopologyPackage.Literals.WORK_CELL;
	}
	...
	public EList<Station> getStations() {
		if (stations == null) {
			stations = new EObjectContainmentEList<Station>(Station.class, this, RoletopologyPackage.WORK_CELL__STATIONS);
		}
		return stations;
	}
