 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.productdefinition.impl.BOMEntryImpl#getCount <em>Count</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BOMEntryImpl extends BasysEObjectImpl implements BOMEntry {
	...
	protected EClass eStaticClass() {
		return ProductdefinitionPackage.Literals.BOM_ENTRY;
	}
	...
	public void setCount(int newCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductdefinitionPackage.BOM_ENTRY__COUNT, oldCount, count));
	}
