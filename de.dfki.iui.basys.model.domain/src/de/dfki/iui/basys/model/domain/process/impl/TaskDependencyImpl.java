 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.TaskDependencyImpl#getSourceState <em>Source State</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.TaskDependencyImpl#getTargetState <em>Target State</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskDependencyImpl extends EdgeImpl implements TaskDependency {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.TASK_DEPENDENCY;
	}
	...
	public void setSourceState(TaskStateEnum newSourceState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK_DEPENDENCY__SOURCE_STATE, oldSourceState, sourceState));
	}
	...
	public void setTargetState(TaskStateEnum newTargetState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK_DEPENDENCY__TARGET_STATE, oldTargetState, targetState));
	}
