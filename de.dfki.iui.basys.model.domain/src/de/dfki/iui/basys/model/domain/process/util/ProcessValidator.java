...
public class ProcessValidator extends EObjectValidator {
	 ...
	 * @generated
	 */
	public static final String DIAGNOSTIC_SOURCE = "de.dfki.iui.basys.model.domain.process";
	...
	public boolean validateTaskFlow_typeCheck(TaskFlow taskFlow, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(ProcessPackage.Literals.TASK_FLOW,
				 taskFlow,
				 diagnostics,
				 context,
	...
	public boolean validateTaskDependency_typeCheck(TaskDependency taskDependency, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(ProcessPackage.Literals.TASK_DEPENDENCY,
				 taskDependency,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
	...
	public boolean validateDataFlow_typeCheck(DataFlow dataFlow, DiagnosticChain diagnostics, Map<Object, Object> context) {
		return
			validate
				(ProcessPackage.Literals.DATA_FLOW,
				 dataFlow,
				 diagnostics,
				 context,
				 "http://www.eclipse.org/emf/2002/Ecore/OCL",
