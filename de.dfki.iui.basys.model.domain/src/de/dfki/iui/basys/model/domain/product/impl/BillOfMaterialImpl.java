 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.product.impl.BillOfMaterialImpl#getEntries <em>Entries</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BillOfMaterialImpl extends EntityImpl implements BillOfMaterial {
	...
	protected EClass eStaticClass() {
		return ProductPackage.Literals.BILL_OF_MATERIAL;
	}
	...
	public EList<BOMEntry> getEntries() {
		if (entries == null) {
			entries = new EObjectContainmentEList<BOMEntry>(BOMEntry.class, this, ProductPackage.BILL_OF_MATERIAL__ENTRIES);
		}
		return entries;
	}
