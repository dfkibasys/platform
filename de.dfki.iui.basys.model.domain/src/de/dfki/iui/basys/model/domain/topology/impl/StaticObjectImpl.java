...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Static Object</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.impl.StaticObjectImpl#getControlModules <em>Control Modules</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.impl.StaticObjectImpl#getEquipmentModules <em>Equipment Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StaticObjectImpl extends IdentifiableEntityImpl implements StaticObject {
	/**
	...
	protected EClass eStaticClass() {
		return TopologyPackage.Literals.STATIC_OBJECT;
	}
	...
	public EList<ControlModule> getControlModules() {
		if (controlModules == null) {
			controlModules = new EObjectContainmentEList<ControlModule>(ControlModule.class, this, TopologyPackage.STATIC_OBJECT__CONTROL_MODULES);
		}
	...
	public EList<EquipmentModule> getEquipmentModules() {
		if (equipmentModules == null) {
			equipmentModules = new EObjectContainmentEList<EquipmentModule>(EquipmentModule.class, this, TopologyPackage.STATIC_OBJECT__EQUIPMENT_MODULES);
		}
