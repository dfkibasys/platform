 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.EdgeImpl#getSourceRef <em>Source Ref</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.EdgeImpl#getTargetRef <em>Target Ref</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EdgeImpl extends EntityImpl implements Edge {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.EDGE;
	}
		...
		if (sourceRef != null && sourceRef.eIsProxy()) {
			...
			if (sourceRef != oldSourceRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.EDGE__SOURCE_REF, oldSourceRef, sourceRef));
			}
		}
		return sourceRef;
	}
	...
	public NotificationChain basicSetSourceRef(Node newSourceRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.EDGE__SOURCE_REF, oldSourceRef, newSourceRef);
	...
	public void setSourceRef(Node newSourceRef) {
		if (newSourceRef != sourceRef) {
			...
			if (sourceRef != null)
				msgs = ((InternalEObject)sourceRef).eInverseRemove(this, ProcessPackage.NODE__OUTGOING, Node.class, msgs);
			if (newSourceRef != null)
				msgs = ((InternalEObject)newSourceRef).eInverseAdd(this, ProcessPackage.NODE__OUTGOING, Node.class, msgs);
			msgs = basicSetSourceRef(newSourceRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.EDGE__SOURCE_REF, newSourceRef, newSourceRef));
	}
	...
	public Node getTargetRef() {
		if (targetRef != null && targetRef.eIsProxy()) {
			...
			if (targetRef != oldTargetRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.EDGE__TARGET_REF, oldTargetRef, targetRef));
			}
		}
		return targetRef;
	}
	...
	public NotificationChain basicSetTargetRef(Node newTargetRef, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.EDGE__TARGET_REF, oldTargetRef, newTargetRef);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTargetRef(Node newTargetRef) {
		if (newTargetRef != targetRef) {
			NotificationChain msgs = null;
			if (targetRef != null)
				msgs = ((InternalEObject)targetRef).eInverseRemove(this, ProcessPackage.NODE__INCOMING, Node.class, msgs);
			if (newTargetRef != null)
				msgs = ((InternalEObject)newTargetRef).eInverseAdd(this, ProcessPackage.NODE__INCOMING, Node.class, msgs);
			msgs = basicSetTargetRef(newTargetRef, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.EDGE__TARGET_REF, newTargetRef, newTargetRef));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.EDGE__SOURCE_REF:
				if (sourceRef != null)
					msgs = ((InternalEObject)sourceRef).eInverseRemove(this, ProcessPackage.NODE__OUTGOING, Node.class, msgs);
				return basicSetSourceRef((Node)otherEnd, msgs);
			case ProcessPackage.EDGE__TARGET_REF:
				if (targetRef != null)
					msgs = ((InternalEObject)targetRef).eInverseRemove(this, ProcessPackage.NODE__INCOMING, Node.class, msgs);
