 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.impl.FixtureImpl#getControlModules <em>Control Modules</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.impl.FixtureImpl#getEquipmentModules <em>Equipment Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FixtureImpl extends IdentifiableEntityImpl implements Fixture {
	/**
	...
	protected EClass eStaticClass() {
		return TopologyPackage.Literals.FIXTURE;
	}
	...
	public EList<ControlModule> getControlModules() {
		if (controlModules == null) {
			controlModules = new EObjectContainmentEList<ControlModule>(ControlModule.class, this, TopologyPackage.FIXTURE__CONTROL_MODULES);
		}
	...
	public EList<EquipmentModule> getEquipmentModules() {
		if (equipmentModules == null) {
			equipmentModules = new EObjectContainmentEList<EquipmentModule>(EquipmentModule.class, this, TopologyPackage.FIXTURE__EQUIPMENT_MODULES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TopologyPackage.FIXTURE__CONTROL_MODULES:
				return ((InternalEList<?>)getControlModules()).basicRemove(otherEnd, msgs);
			case TopologyPackage.FIXTURE__EQUIPMENT_MODULES:
