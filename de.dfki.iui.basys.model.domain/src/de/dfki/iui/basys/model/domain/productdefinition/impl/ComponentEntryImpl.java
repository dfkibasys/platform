 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.productdefinition.impl.ComponentEntryImpl#getMaterial <em>Material</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComponentEntryImpl extends BOMEntryImpl implements ComponentEntry {
	...
	protected EClass eStaticClass() {
		return ProductdefinitionPackage.Literals.COMPONENT_ENTRY;
	}
		...
		if (material != null && material.eIsProxy()) {
			...
			if (material != oldMaterial) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProductdefinitionPackage.COMPONENT_ENTRY__MATERIAL, oldMaterial, material));
			}
		}
		return material;
	}
	...
	public void setMaterial(Material newMaterial) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductdefinitionPackage.COMPONENT_ENTRY__MATERIAL, oldMaterial, material));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProductdefinitionPackage.COMPONENT_ENTRY__MATERIAL:
