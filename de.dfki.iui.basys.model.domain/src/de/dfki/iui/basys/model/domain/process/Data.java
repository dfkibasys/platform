 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.Data#getAvailableOn <em>Available On</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.Data#getTaskRef <em>Task Ref</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.Data#getPattern <em>Pattern</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.Data#getInstance <em>Instance</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.Data#getMappings <em>Mappings</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getData()
 * @model
 * @generated
 */
public interface Data extends Node {
	 ...
	 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getData_AvailableOn()
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.process.Data#getAvailableOn <em>Available On</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setTaskRef(Task)
	 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getData_TaskRef()
	 * @model
	 * @generated
	 */
	Task getTaskRef();
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.process.Data#getTaskRef <em>Task Ref</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getData_Pattern()
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.process.Data#getPattern <em>Pattern</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getData_Instance()
	 * @model
	 * @generated
	 */
	Object getInstance();
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.process.Data#getInstance <em>Instance</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getData_Mappings()
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.process.Data#getMappings <em>Mappings</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
