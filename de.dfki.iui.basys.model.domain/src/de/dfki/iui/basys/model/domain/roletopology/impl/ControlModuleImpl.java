 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.roletopology.impl.ControlModuleImpl#getControlModules <em>Control Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class ControlModuleImpl extends EntityImpl implements ControlModule {
	...
	protected EClass eStaticClass() {
		return RoletopologyPackage.Literals.CONTROL_MODULE;
	}
	...
	public EList<ControlModule> getControlModules() {
		if (controlModules == null) {
			controlModules = new EObjectContainmentEList<ControlModule>(ControlModule.class, this, RoletopologyPackage.CONTROL_MODULE__CONTROL_MODULES);
		}
