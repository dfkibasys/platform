 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.TaskFlow#getSourceState <em>Source State</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.TaskFlow#getTargetState <em>Target State</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.TaskFlow#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getTaskFlow()
...
public interface TaskFlow extends Edge {
	 ...
	 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getTaskFlow_SourceState()
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.process.TaskFlow#getSourceState <em>Source State</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getTaskFlow_TargetState()
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.process.TaskFlow#getTargetState <em>Target State</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.iui.basys.model.domain.process.ProcessPackage#getTaskFlow_Condition()
	 * @model
	 * @generated
	 */
	String getCondition();
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.process.TaskFlow#getCondition <em>Condition</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
