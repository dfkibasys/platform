 ...
 * @generated
 */
public class WorkerguidanceSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case WorkerguidancePackage.AUDIO: {
			...
			case WorkerguidancePackage.VIDEO: {
			...
			case WorkerguidancePackage.IMAGE: {
