 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.UsedMaterialImpl#getCount <em>Count</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.UsedMaterialImpl#getBomEntry <em>Bom Entry</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UsedMaterialImpl extends BasysEObjectImpl implements UsedMaterial {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.USED_MATERIAL;
	}
	...
	public void setCount(int newCount) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.USED_MATERIAL__COUNT, oldCount, count));
	}
	...
	public BOMEntry getBomEntry() {
		if (bomEntry != null && bomEntry.eIsProxy()) {
			...
			if (bomEntry != oldBomEntry) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.USED_MATERIAL__BOM_ENTRY, oldBomEntry, bomEntry));
			}
		}
		return bomEntry;
	}
	...
	public void setBomEntry(BOMEntry newBomEntry) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.USED_MATERIAL__BOM_ENTRY, oldBomEntry, bomEntry));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcessPackage.USED_MATERIAL__COUNT:
				return getCount();
			case ProcessPackage.USED_MATERIAL__BOM_ENTRY:
