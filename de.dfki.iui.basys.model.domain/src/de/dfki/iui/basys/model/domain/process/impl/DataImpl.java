 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.DataImpl#getAvailableOn <em>Available On</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.DataImpl#getTaskRef <em>Task Ref</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.DataImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.DataImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.DataImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DataImpl extends NodeImpl implements Data {
	...
	public void setAvailableOn(TaskStateEnum newAvailableOn) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__AVAILABLE_ON, oldAvailableOn, availableOn));
	}
	...
	public Task getTaskRef() {
		if (taskRef != null && taskRef.eIsProxy()) {
			...
			if (taskRef != oldTaskRef) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProcessPackage.DATA__TASK_REF, oldTaskRef, taskRef));
			}
		}
		return taskRef;
	}
	...
	public void setTaskRef(Task newTaskRef) {
		...
		taskRef = newTaskRef;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__TASK_REF, oldTaskRef, taskRef));
	}
	...
	public NotificationChain basicSetPattern(PPattern newPattern, NotificationChain msgs) {
		...
		pattern = newPattern;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__PATTERN, oldPattern, newPattern);
	...
	public void setPattern(PPattern newPattern) {
		if (newPattern != pattern) {
			...
			if (pattern != null)
				msgs = ((InternalEObject)pattern).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.DATA__PATTERN, null, msgs);
			if (newPattern != null)
				msgs = ((InternalEObject)newPattern).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.DATA__PATTERN, null, msgs);
			msgs = basicSetPattern(newPattern, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__PATTERN, newPattern, newPattern));
	}
	...
	public void setInstance(Object newInstance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__INSTANCE, oldInstance, instance));
	}
	...
	public NotificationChain basicSetMappings(DataMapping newMappings, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__MAPPINGS, oldMappings, newMappings);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setMappings(DataMapping newMappings) {
		if (newMappings != mappings) {
			NotificationChain msgs = null;
			if (mappings != null)
				msgs = ((InternalEObject)mappings).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.DATA__MAPPINGS, null, msgs);
			if (newMappings != null)
				msgs = ((InternalEObject)newMappings).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProcessPackage.DATA__MAPPINGS, null, msgs);
			msgs = basicSetMappings(newMappings, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.DATA__MAPPINGS, newMappings, newMappings));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProcessPackage.DATA__PATTERN:
				return basicSetPattern(null, msgs);
			case ProcessPackage.DATA__MAPPINGS:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProcessPackage.DATA__AVAILABLE_ON:
				return getAvailableOn();
			case ProcessPackage.DATA__TASK_REF:
				if (resolve) return getTaskRef();
				return basicGetTaskRef();
			case ProcessPackage.DATA__PATTERN:
				return getPattern();
			case ProcessPackage.DATA__INSTANCE:
				return getInstance();
			case ProcessPackage.DATA__MAPPINGS:
				return getMappings();
		}
