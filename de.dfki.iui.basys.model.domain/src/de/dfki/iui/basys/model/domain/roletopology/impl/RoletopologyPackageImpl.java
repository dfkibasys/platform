...
import de.dfki.iui.basys.model.domain.roletopology.ProcessCell;
import de.dfki.iui.basys.model.domain.roletopology.ProductionLine;
import de.dfki.iui.basys.model.domain.roletopology.ProductionUnit;
import de.dfki.iui.basys.model.domain.roletopology.Requirement;
import de.dfki.iui.basys.model.domain.roletopology.RoletopologyFactory;
...
import de.dfki.iui.basys.model.domain.roletopology.Station;
...
import de.dfki.iui.basys.model.domain.roletopology.Transition;
import de.dfki.iui.basys.model.domain.roletopology.Unit;
 ...
 * @generated
 */
public class RoletopologyPackageImpl extends EPackageImpl implements RoletopologyPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see de.dfki.iui.basys.model.domain.roletopology.RoletopologyPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private RoletopologyPackageImpl() {
		super(eNS_URI, RoletopologyFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link RoletopologyPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static RoletopologyPackage init() {
		if (isInited) return (RoletopologyPackage)EPackage.Registry.INSTANCE.getEPackage(RoletopologyPackage.eNS_URI);

		// Obtain or create and register package
		RoletopologyPackageImpl theRoletopologyPackage = (RoletopologyPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof RoletopologyPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new RoletopologyPackageImpl());
		...
		EPackage.Registry.INSTANCE.put(RoletopologyPackage.eNS_URI, theRoletopologyPackage);
		return theRoletopologyPackage;
	}
	 ...
	 * @generated
	 */
	public EReference getArea_Discretemanufacturingequipmentmodules() {
	 ...
	 * @generated
	 */
	public EReference getDiscreteManufacturingEquipmentModule_Requirements() {
		return (EReference)discreteManufacturingEquipmentModuleEClass.getEStructuralFeatures().get(0);
	}
	 ...
	 * @generated
	 */
	public EAttribute getRequirement_ValueRange() {
	 ...
	 * @generated
	 */
	public EAttribute getRequirement_Unit() {
	 ...
	 * @generated
	 */
	public RoletopologyFactory getRoletopologyFactory() {
		return (RoletopologyFactory)getEFactoryInstance();
	}
	...
	public void createPackageContents() {
		...
		createEReference(areaEClass, AREA__DISCRETEMANUFACTURINGEQUIPMENTMODULES);
		...
		createEReference(discreteManufacturingEquipmentModuleEClass, DISCRETE_MANUFACTURING_EQUIPMENT_MODULE__REQUIREMENTS);

		requirementEClass = createEClass(REQUIREMENT);
		createEAttribute(requirementEClass, REQUIREMENT__PROPERTY);
		createEAttribute(requirementEClass, REQUIREMENT__VALUE_RANGE);
		createEAttribute(requirementEClass, REQUIREMENT__UNIT);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getArea_Discretemanufacturingequipmentmodules(), this.getDiscreteManufacturingEquipmentModule(), null, "discretemanufacturingequipmentmodules", null, 0, -1, Area.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getDiscreteManufacturingEquipmentModule_Requirements(), this.getRequirement(), null, "requirements", null, 0, -1, DiscreteManufacturingEquipmentModule.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(requirementEClass, Requirement.class, "Requirement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getRequirement_Property(), theXMLTypePackage.getString(), "property", null, 0, 1, Requirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequirement_ValueRange(), theXMLTypePackage.getString(), "valueRange", null, 0, 1, Requirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRequirement_Unit(), theXMLTypePackage.getString(), "unit", null, 0, 1, Requirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Create resource
		createResource(eNS_URI);
	}

} //RoletopologyPackageImpl
