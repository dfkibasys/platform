 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.roletopology.impl.SiteImpl#getAreas <em>Areas</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SiteImpl extends EntityImpl implements Site {
	...
	protected EClass eStaticClass() {
		return RoletopologyPackage.Literals.SITE;
	}
	...
	public EList<Area> getAreas() {
		if (areas == null) {
			areas = new EObjectContainmentEList<Area>(Area.class, this, RoletopologyPackage.SITE__AREAS);
		}
		return areas;
	}
