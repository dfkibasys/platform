 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.workplan.impl.WorkstepInstanceStatusChangeEventImpl#getStatus <em>Status</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.workplan.impl.WorkstepInstanceStatusChangeEventImpl#getProductInstanceId <em>Product Instance Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.workplan.impl.WorkstepInstanceStatusChangeEventImpl#getWorkstepInstanceId <em>Workstep Instance Id</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkstepInstanceStatusChangeEventImpl extends EventImpl implements WorkstepInstanceStatusChangeEvent {
	/**
	...
	public void setStatus(WorkstepInstanceStatusEnum newStatus) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkplanPackage.WORKSTEP_INSTANCE_STATUS_CHANGE_EVENT__STATUS, oldStatus, status));
	}
	...
	public void setProductInstanceId(String newProductInstanceId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkplanPackage.WORKSTEP_INSTANCE_STATUS_CHANGE_EVENT__PRODUCT_INSTANCE_ID, oldProductInstanceId, productInstanceId));
	}
	...
	public void setWorkstepInstanceId(String newWorkstepInstanceId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkplanPackage.WORKSTEP_INSTANCE_STATUS_CHANGE_EVENT__WORKSTEP_INSTANCE_ID, oldWorkstepInstanceId, workstepInstanceId));
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == WorkstepInstanceStatus.class) {
			switch (derivedFeatureID) {
				case WorkplanPackage.WORKSTEP_INSTANCE_STATUS_CHANGE_EVENT__STATUS: return WorkplanPackage.WORKSTEP_INSTANCE_STATUS__STATUS;
				case WorkplanPackage.WORKSTEP_INSTANCE_STATUS_CHANGE_EVENT__PRODUCT_INSTANCE_ID: return WorkplanPackage.WORKSTEP_INSTANCE_STATUS__PRODUCT_INSTANCE_ID;
				case WorkplanPackage.WORKSTEP_INSTANCE_STATUS_CHANGE_EVENT__WORKSTEP_INSTANCE_ID: return WorkplanPackage.WORKSTEP_INSTANCE_STATUS__WORKSTEP_INSTANCE_ID;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == WorkstepInstanceStatus.class) {
			switch (baseFeatureID) {
				case WorkplanPackage.WORKSTEP_INSTANCE_STATUS__STATUS: return WorkplanPackage.WORKSTEP_INSTANCE_STATUS_CHANGE_EVENT__STATUS;
				case WorkplanPackage.WORKSTEP_INSTANCE_STATUS__PRODUCT_INSTANCE_ID: return WorkplanPackage.WORKSTEP_INSTANCE_STATUS_CHANGE_EVENT__PRODUCT_INSTANCE_ID;
				case WorkplanPackage.WORKSTEP_INSTANCE_STATUS__WORKSTEP_INSTANCE_ID: return WorkplanPackage.WORKSTEP_INSTANCE_STATUS_CHANGE_EVENT__WORKSTEP_INSTANCE_ID;
				default: return -1;
			}
		}
