 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.impl.UnitImpl#getEquipmentModules <em>Equipment Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public class UnitImpl extends IdentifiableEntityImpl implements Unit {
	/**
	...
	protected EClass eStaticClass() {
		return TopologyPackage.Literals.UNIT;
	}
	...
	public EList<EquipmentModule> getEquipmentModules() {
		if (equipmentModules == null) {
			equipmentModules = new EObjectContainmentEList<EquipmentModule>(EquipmentModule.class, this, TopologyPackage.UNIT__EQUIPMENT_MODULES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case TopologyPackage.UNIT__EQUIPMENT_MODULES:
