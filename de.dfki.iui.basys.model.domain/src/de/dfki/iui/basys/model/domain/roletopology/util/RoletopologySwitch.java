 ...
 * @generated
 */
public class RoletopologySwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RoletopologyPackage.ENTERPRISE: {
			...
			case RoletopologyPackage.WORK_CENTER: {
			...
			case RoletopologyPackage.PROCESS_CELL: {
			...
			case RoletopologyPackage.PRODUCTION_UNIT: {
			...
			case RoletopologyPackage.PRODUCTION_LINE: {
			...
			case RoletopologyPackage.STORAGE_ZONE: {
			...
			case RoletopologyPackage.WORK_UNIT: {
			...
			case RoletopologyPackage.WORK_CELL: {
			...
			case RoletopologyPackage.STORAGE_UNIT: {
			...
			case RoletopologyPackage.EQUIPMENT_MODULE: {
			...
			case RoletopologyPackage.CONTROL_MODULE: {
			...
			case RoletopologyPackage.STATION: {
			...
			case RoletopologyPackage.TRANSITION: {
				Transition transition = (Transition)theEObject;
				T result = caseTransition(transition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RoletopologyPackage.DISCRETE_MANUFACTURING_EQUIPMENT_MODULE: {
			...
			case RoletopologyPackage.REQUIREMENT: {
