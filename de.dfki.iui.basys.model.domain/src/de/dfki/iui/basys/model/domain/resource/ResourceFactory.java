...
public interface ResourceFactory extends EFactory {
	 ...
	 * @generated
	 */
	ResourceFactory eINSTANCE = de.dfki.iui.basys.model.domain.resource.impl.ResourceFactoryImpl.init();

	/**
	 * Returns a new object of class '<em>Type Catalogue</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Type Catalogue</em>'.
	 * @generated
	 */
	ResourceTypeCatalogue createResourceTypeCatalogue();
