 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.ControlModule#getControlModules <em>Control Modules</em>}</li>
 * </ul>
 *
...
public interface ControlModule extends IdentifiableEntity {
	 ...
	 * @see de.dfki.iui.basys.model.domain.topology.TopologyPackage#getControlModule_ControlModules()
