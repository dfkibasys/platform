 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.product.impl.ProductInstanceImpl#getProductVariantId <em>Product Variant Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.product.impl.ProductInstanceImpl#getOrderId <em>Order Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.product.impl.ProductInstanceImpl#getSerialNumber <em>Serial Number</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductInstanceImpl extends IdentifiableEntityImpl implements ProductInstance {
	...
	protected EClass eStaticClass() {
		return ProductPackage.Literals.PRODUCT_INSTANCE;
	}
	...
	public void setProductVariantId(String newProductVariantId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductPackage.PRODUCT_INSTANCE__PRODUCT_VARIANT_ID, oldProductVariantId, productVariantId));
	}
	...
	public void setOrderId(String newOrderId) {
		...
		orderId = newOrderId;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductPackage.PRODUCT_INSTANCE__ORDER_ID, oldOrderId, orderId));
	}
	...
	public void setSerialNumber(String newSerialNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductPackage.PRODUCT_INSTANCE__SERIAL_NUMBER, oldSerialNumber, serialNumber));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProductPackage.PRODUCT_INSTANCE__PRODUCT_VARIANT_ID:
				return getProductVariantId();
			case ProductPackage.PRODUCT_INSTANCE__ORDER_ID:
				return getOrderId();
			case ProductPackage.PRODUCT_INSTANCE__SERIAL_NUMBER:
