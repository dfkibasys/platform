 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.process.impl.TaskStateImpl#getTimestamp <em>Timestamp</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class TaskStateImpl extends BasysEObjectImpl implements TaskState {
	...
	protected EClass eStaticClass() {
		return ProcessPackage.Literals.TASK_STATE;
	}
	...
	public void setTimestamp(Date newTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessPackage.TASK_STATE__TIMESTAMP, oldTimestamp, timestamp));
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case ProcessPackage.TASK_STATE___TO_ENUM:
				return toEnum();
		}
