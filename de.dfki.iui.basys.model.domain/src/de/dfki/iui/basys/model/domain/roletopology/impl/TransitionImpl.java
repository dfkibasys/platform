 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.roletopology.impl.TransitionImpl#getComponentId_src <em>Component Id src</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.roletopology.impl.TransitionImpl#getComponentId_target <em>Component Id target</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.roletopology.impl.TransitionImpl#getDistance <em>Distance</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TransitionImpl extends BasysEObjectImpl implements Transition {
	...
	protected EClass eStaticClass() {
		return RoletopologyPackage.Literals.TRANSITION;
	}
	...
	public void setComponentId_src(String newComponentId_src) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoletopologyPackage.TRANSITION__COMPONENT_ID_SRC, oldComponentId_src, componentId_src));
	}
	...
	public void setComponentId_target(String newComponentId_target) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoletopologyPackage.TRANSITION__COMPONENT_ID_TARGET, oldComponentId_target, componentId_target));
	}
	...
	public void setDistance(float newDistance) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, RoletopologyPackage.TRANSITION__DISTANCE, oldDistance, distance));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case RoletopologyPackage.TRANSITION__COMPONENT_ID_SRC:
				return getComponentId_src();
			case RoletopologyPackage.TRANSITION__COMPONENT_ID_TARGET:
				return getComponentId_target();
			case RoletopologyPackage.TRANSITION__DISTANCE:
				return getDistance();
		}
