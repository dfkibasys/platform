 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.productinstance.ProductInstanceLocation#getDetectionType <em>Detection Type</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.productinstance.ProductInstanceLocation#getProductInstanceId <em>Product Instance Id</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.productinstance.ProductInstanceLocation#getComponentId <em>Component Id</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.basys.model.domain.productinstance.ProductinstancePackage#getProductInstanceLocation()
 * @model
 * @generated
 */
public interface ProductInstanceLocation extends Entity {
	 ...
	 * The literals are from the enumeration {@link de.dfki.iui.basys.model.domain.productinstance.ProductInstanceDetectionEnum}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.iui.basys.model.domain.productinstance.ProductinstancePackage#getProductInstanceLocation_DetectionType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.productinstance.ProductInstanceLocation#getDetectionType <em>Detection Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.iui.basys.model.domain.productinstance.ProductinstancePackage#getProductInstanceLocation_ProductInstanceId()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.productinstance.ProductInstanceLocation#getProductInstanceId <em>Product Instance Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.iui.basys.model.domain.productinstance.ProductinstancePackage#getProductInstanceLocation_ComponentId()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.productinstance.ProductInstanceLocation#getComponentId <em>Component Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
