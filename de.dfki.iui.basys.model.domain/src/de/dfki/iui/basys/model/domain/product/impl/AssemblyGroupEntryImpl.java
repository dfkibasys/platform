 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.product.impl.AssemblyGroupEntryImpl#getAssemblyGroup <em>Assembly Group</em>}</li>
 * </ul>
 *
 * @generated
 */
public class AssemblyGroupEntryImpl extends BOMEntryImpl implements AssemblyGroupEntry {
	...
	protected EClass eStaticClass() {
		return ProductPackage.Literals.ASSEMBLY_GROUP_ENTRY;
	}
		...
		if (assemblyGroup != null && assemblyGroup.eIsProxy()) {
			...
			if (assemblyGroup != oldAssemblyGroup) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ProductPackage.ASSEMBLY_GROUP_ENTRY__ASSEMBLY_GROUP, oldAssemblyGroup, assemblyGroup));
			}
		}
	...
	public void setAssemblyGroup(AssemblyGroup newAssemblyGroup) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductPackage.ASSEMBLY_GROUP_ENTRY__ASSEMBLY_GROUP, oldAssemblyGroup, assemblyGroup));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ProductPackage.ASSEMBLY_GROUP_ENTRY__ASSEMBLY_GROUP:
