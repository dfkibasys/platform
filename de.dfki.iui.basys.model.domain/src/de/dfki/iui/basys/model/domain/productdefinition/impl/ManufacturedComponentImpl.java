 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.productdefinition.impl.ManufacturedComponentImpl#getBom <em>Bom</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ManufacturedComponentImpl extends EntityImpl implements ManufacturedComponent {
	...
	protected EClass eStaticClass() {
		return ProductdefinitionPackage.Literals.MANUFACTURED_COMPONENT;
	}
	...
	public NotificationChain basicSetBom(BillOfMaterial newBom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ProductdefinitionPackage.MANUFACTURED_COMPONENT__BOM, oldBom, newBom);
	...
	public void setBom(BillOfMaterial newBom) {
		if (newBom != bom) {
			...
			if (bom != null)
				msgs = ((InternalEObject)bom).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - ProductdefinitionPackage.MANUFACTURED_COMPONENT__BOM, null, msgs);
			if (newBom != null)
				msgs = ((InternalEObject)newBom).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - ProductdefinitionPackage.MANUFACTURED_COMPONENT__BOM, null, msgs);
			msgs = basicSetBom(newBom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductdefinitionPackage.MANUFACTURED_COMPONENT__BOM, newBom, newBom));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProductdefinitionPackage.MANUFACTURED_COMPONENT__BOM:
