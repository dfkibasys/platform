 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.roletopology.impl.EquipmentModuleImpl#getControlModules <em>Control Modules</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.roletopology.impl.EquipmentModuleImpl#getEquipmentModules <em>Equipment Modules</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class EquipmentModuleImpl extends EntityImpl implements EquipmentModule {
	...
	protected EClass eStaticClass() {
		return RoletopologyPackage.Literals.EQUIPMENT_MODULE;
	}
	...
	public EList<ControlModule> getControlModules() {
		if (controlModules == null) {
			controlModules = new EObjectContainmentEList<ControlModule>(ControlModule.class, this, RoletopologyPackage.EQUIPMENT_MODULE__CONTROL_MODULES);
		}
	...
	public EList<EquipmentModule> getEquipmentModules() {
		if (equipmentModules == null) {
			equipmentModules = new EObjectContainmentEList<EquipmentModule>(EquipmentModule.class, this, RoletopologyPackage.EQUIPMENT_MODULE__EQUIPMENT_MODULES);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case RoletopologyPackage.EQUIPMENT_MODULE__CONTROL_MODULES:
				return ((InternalEList<?>)getControlModules()).basicRemove(otherEnd, msgs);
			case RoletopologyPackage.EQUIPMENT_MODULE__EQUIPMENT_MODULES:
