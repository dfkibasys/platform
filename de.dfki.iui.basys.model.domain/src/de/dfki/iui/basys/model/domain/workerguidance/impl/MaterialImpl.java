 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.workerguidance.impl.MaterialImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MaterialImpl extends IdentifiableEntityImpl implements Material {
	...
	protected EClass eStaticClass() {
		return WorkerguidancePackage.Literals.MATERIAL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, WorkerguidancePackage.MATERIAL__NAME, oldName, name));
	}
