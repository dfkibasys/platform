 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.StorageZone#getStorageUnits <em>Storage Units</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.basys.model.domain.topology.TopologyPackage#getStorageZone()
 * @model
 * @generated
 */
public interface StorageZone extends WorkCenter {
	 ...
	 * The list contents are of type {@link de.dfki.iui.basys.model.domain.topology.StorageUnit}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.iui.basys.model.domain.topology.TopologyPackage#getStorageZone_StorageUnits()
