...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.domain.Audio} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AudioItemProvider extends MediaItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.AUDIO__DURATION,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Audio.class)) {
			case DomainPackage.AUDIO__DURATION:
