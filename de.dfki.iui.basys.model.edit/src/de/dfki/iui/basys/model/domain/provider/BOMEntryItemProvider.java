...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.domain.BOMEntry} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BOMEntryItemProvider 
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addMaterialIdPropertyDescriptor(object);
		}
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BOMEntry_amount_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BOMEntry_amount_feature", "_UI_BOMEntry_type"),
				 DomainPackage.Literals.BOM_ENTRY__AMOUNT,
				 true,
				 false,
				 false,
	...
	/**
	 * This adds a property descriptor for the Material Id feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addMaterialIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BOMEntry_materialId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BOMEntry_materialId_feature", "_UI_BOMEntry_type"),
				 DomainPackage.Literals.BOM_ENTRY__MATERIAL_ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_BOMEntry_type") + " " + bomEntry.getAmount();
	}
