...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.domain.Workstep} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class WorkstepItemProvider extends IdentifiableEntityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 DomainPackage.Literals.WORKSTEP__NAME,
				 true,
				 false,
				 false,
	...
	protected void addDurationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Workstep_duration_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Workstep_duration_feature", "_UI_Workstep_type"),
				 DomainPackage.Literals.WORKSTEP__DURATION,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(DomainPackage.Literals.WORKSTEP__BOM);
			childrenFeatures.add(DomainPackage.Literals.WORKSTEP__REQUIREMENTS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.WORKSTEP__BOM,
				 DomainFactory.eINSTANCE.createBOM()));

		newChildDescriptors.add
			(createChildParameter
				(DomainPackage.Literals.WORKSTEP__REQUIREMENTS,
				 DomainFactory.eINSTANCE.createCapabilityRequirement()));
	}
