...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.physical.StorageUnit} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class StorageUnitItemProvider extends IdentifiableEntityItemProvider {
	 ...
	 * @generated
	 */
	public StorageUnitItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PhysicalPackage.Literals.WORK_UNIT__EQUIPMENT_MODULES);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/StorageUnit"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(StorageUnit.class)) {
			case PhysicalPackage.STORAGE_UNIT__EQUIPMENT_MODULES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PhysicalPackage.Literals.WORK_UNIT__EQUIPMENT_MODULES,
