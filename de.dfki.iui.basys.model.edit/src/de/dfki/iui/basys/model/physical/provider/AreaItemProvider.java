...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.physical.Area} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AreaItemProvider extends IdentifiableEntityItemProvider {
	/**
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(PhysicalPackage.Literals.AREA__WORK_CENTERS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(PhysicalPackage.Literals.AREA__WORK_CENTERS,
				 PhysicalFactory.eINSTANCE.createProcessCell()));

		newChildDescriptors.add
			(createChildParameter
				(PhysicalPackage.Literals.AREA__WORK_CENTERS,
				 PhysicalFactory.eINSTANCE.createProductionUnit()));

		newChildDescriptors.add
			(createChildParameter
				(PhysicalPackage.Literals.AREA__WORK_CENTERS,
				 PhysicalFactory.eINSTANCE.createProductionLine()));

		newChildDescriptors.add
			(createChildParameter
				(PhysicalPackage.Literals.AREA__WORK_CENTERS,
				 PhysicalFactory.eINSTANCE.createStorageZone()));
	}
