...
/**
 * This is the action bar contributor for the Process model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProcessActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("process-settings"));
		toolBarManager.add(new Separator("process-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(DomainEditorPlugin.INSTANCE.getString("_UI_ProcessEditor_menu"), "de.dfki.iui.basys.model.domain.processMenuID");
