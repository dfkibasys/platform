 ...
 * @generated
 */
public class ProductActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("product-settings"));
		toolBarManager.add(new Separator("product-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(DomainEditorPlugin.INSTANCE.getString("_UI_ProductEditor_menu"), "de.dfki.iui.basys.model.domain.productMenuID");
