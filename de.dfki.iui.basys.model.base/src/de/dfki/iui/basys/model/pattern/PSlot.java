 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.pattern.PSlot#getFeature <em>Feature</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.pattern.PSlot#getRange <em>Range</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.pattern.PSlot#getFeatureName <em>Feature Name</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPSlot()
 * @model
 * @generated
 */
public interface PSlot extends EObject {
	 ...
	 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPSlot_Feature()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.pattern.PSlot#getFeature <em>Feature</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.dfki.iui.basys.model.pattern.PPattern}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPSlot_Range()
	 ...
	 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPSlot_FeatureName()
