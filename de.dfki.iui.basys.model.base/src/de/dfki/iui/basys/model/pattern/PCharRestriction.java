 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.pattern.PCharRestriction#isIgnoreCase <em>Ignore Case</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.pattern.PCharRestriction#getValue <em>Value</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.pattern.PCharRestriction#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPCharRestriction()
 * @model superTypes="de.dfki.iui.basys.model.pattern.PRestriction&lt;de.dfki.iui.basys.model.pattern.PCharRestrictionEnum, de.dfki.iui.basys.model.base.BChar&gt;"
 * @generated
 */
public interface PCharRestriction extends PRestriction<PCharRestrictionEnum, BChar> {
	 ...
	 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPCharRestriction_IgnoreCase()
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.pattern.PCharRestriction#isIgnoreCase <em>Ignore Case</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setValue(BChar)
	 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPCharRestriction_Value()
	 * @model dataType="de.dfki.iui.basys.model.base.BChar"
	 * @generated
	 */
	BChar getValue();

	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.pattern.PCharRestriction#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link de.dfki.iui.basys.model.pattern.PCharRestrictionEnum}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPCharRestriction_Function()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.pattern.PCharRestriction#getFunction <em>Function</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
