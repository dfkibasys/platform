 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.pattern.PLongRestriction#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPLongRestriction()
 * @model superTypes="de.dfki.iui.basys.model.pattern.PNumberRestriction&lt;de.dfki.iui.basys.model.base.BLong&gt;"
 * @generated
 */
public interface PLongRestriction extends PNumberRestriction<BLong> {
	 ...
	 * @see #setValue(BLong)
	 * @see de.dfki.iui.basys.model.pattern.PatternPackage#getPLongRestriction_Value()
	 * @model dataType="de.dfki.iui.basys.model.base.BLong"
	 * @generated
	 */
	BLong getValue();

	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.pattern.PLongRestriction#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
