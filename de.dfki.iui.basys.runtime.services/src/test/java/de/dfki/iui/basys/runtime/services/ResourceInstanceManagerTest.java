...
public class ResourceInstanceManagerTest extends BaseComponentTest {
	...
	public void setUp() throws Exception {
		ComponentConfiguration configResourceInstanceManager = new ComponentConfiguration.Builder()
				...
				.externalConnectionString(new File(".").getAbsolutePath() + "\\src\\test\\resources\\model\\cebit.resourceinstance")
				.build();
