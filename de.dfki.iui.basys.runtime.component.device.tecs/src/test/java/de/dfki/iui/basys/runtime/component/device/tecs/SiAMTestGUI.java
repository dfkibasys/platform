...
public class SiAMTestGUI {

	public static void main(String[] args) {
		ComponentConfiguration config = new ComponentConfigurationImpl.Builder().componentId("siam-component")
				.inChannelName("siam-component#in").outChannelName("siam-component#out")
				.componentImplementationJavaClass("de.dfki.iui.basys.runtime.component.device.tecs.SiAMComponent")
