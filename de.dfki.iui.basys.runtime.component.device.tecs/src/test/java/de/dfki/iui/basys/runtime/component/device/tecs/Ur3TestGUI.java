...
public class Ur3TestGUI {

	public static void main(String[] args) {
		ComponentConfiguration config = new ComponentConfigurationImpl.Builder().componentId("ur3-component")
				.inChannelName("ur3-component#in").outChannelName("ur3-component#out")
				.componentImplementationJavaClass("de.dfki.iui.basys.runtime.component.device.tecs.Ur3Component")
		...
		Ur3Component mir100 = new Ur3Component(config);
