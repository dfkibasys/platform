...
public class FrankaTestGUI {

	public static void main(String[] args) {
		ComponentConfiguration config = new ComponentConfigurationImpl.Builder().componentId("franka-component")
				.inChannelName("franka-component#in").outChannelName("franka-component#out")
				.componentImplementationJavaClass("de.dfki.iui.basys.runtime.component.device.tecs.FrankaComponent")
		...
		FrankaComponent mir100 = new FrankaComponent(config);
		
		Frame frame = new Frame("Franka UI");
