...
public class HueLightsTestGUI {

	public static void main(String[] args) {
		ComponentConfiguration config = new ComponentConfigurationImpl.Builder().componentId("huelights-component")
				.inChannelName("huelights-component#in").outChannelName("huelights-component#out")
				.componentImplementationJavaClass("de.dfki.iui.basys.runtime.component.device.tecs.HueLightsComponent")
		...
		Frame frame = new Frame("HueLights UI");
