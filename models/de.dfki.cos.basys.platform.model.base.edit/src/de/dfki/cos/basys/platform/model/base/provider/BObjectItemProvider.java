...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.base.BObject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class BObjectItemProvider 
	 ...
	 * @generated
	 */
	public BObjectItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BObject"));
	}
	...
	public String getText(Object object) {
		String label = ((BObject)object).getBinding();
		return label == null || label.length() == 0 ?
			getString("_UI_BObject_type") :
			getString("_UI_BObject_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(BObject.class)) {
