 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see de.dfki.iui.basys.model.data.DataFactory
 * @model kind="package"
...
public interface DataPackage extends EPackage {
	 ...
	 * @generated
	 */
	DataPackage eINSTANCE = de.dfki.iui.basys.model.data.impl.DataPackageImpl.init();

	/**
	 * The meta object id for the '{@link de.dfki.iui.basys.model.data.impl.CartesianCoordinateImpl <em>Cartesian Coordinate</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.dfki.iui.basys.model.data.impl.CartesianCoordinateImpl
	 * @see de.dfki.iui.basys.model.data.impl.DataPackageImpl#getCartesianCoordinate()
	 * @generated
	 */
	...
	/**
	 * The meta object id for the '{@link de.dfki.iui.basys.model.data.impl.PathImpl <em>Path</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.dfki.iui.basys.model.data.impl.PathImpl
	 * @see de.dfki.iui.basys.model.data.impl.DataPackageImpl#getPath()
	 * @generated
	 */
	int PATH = 1;
	...
	/**
	 * Returns the meta object for class '{@link de.dfki.iui.basys.model.data.CartesianCoordinate <em>Cartesian Coordinate</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Cartesian Coordinate</em>'.
	 * @see de.dfki.iui.basys.model.data.CartesianCoordinate
	 * @generated
	 */
	EClass getCartesianCoordinate();

	/**
	 * Returns the meta object for the attribute '{@link de.dfki.iui.basys.model.data.CartesianCoordinate#getX <em>X</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>X</em>'.
	 * @see de.dfki.iui.basys.model.data.CartesianCoordinate#getX()
	...
	/**
	 * Returns the meta object for the attribute '{@link de.dfki.iui.basys.model.data.CartesianCoordinate#getY <em>Y</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Y</em>'.
	 * @see de.dfki.iui.basys.model.data.CartesianCoordinate#getY()
	 * @see #getCartesianCoordinate()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for the attribute '{@link de.dfki.iui.basys.model.data.CartesianCoordinate#getZ <em>Z</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Z</em>'.
	 * @see de.dfki.iui.basys.model.data.CartesianCoordinate#getZ()
	 * @see #getCartesianCoordinate()
	 * @generated
	 */
	...
	/**
	 * Returns the meta object for class '{@link de.dfki.iui.basys.model.data.Path <em>Path</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Path</em>'.
	 * @see de.dfki.iui.basys.model.data.Path
	 * @generated
	 */
	EClass getPath();

	/**
	 * Returns the meta object for the containment reference list '{@link de.dfki.iui.basys.model.data.Path#getCoordinates <em>Coordinates</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Coordinates</em>'.
	 * @see de.dfki.iui.basys.model.data.Path#getCoordinates()
	 * @see #getPath()
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link de.dfki.iui.basys.model.data.impl.CartesianCoordinateImpl <em>Cartesian Coordinate</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.dfki.iui.basys.model.data.impl.CartesianCoordinateImpl
		 * @see de.dfki.iui.basys.model.data.impl.DataPackageImpl#getCartesianCoordinate()
		...
		/**
		 * The meta object literal for the '{@link de.dfki.iui.basys.model.data.impl.PathImpl <em>Path</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.dfki.iui.basys.model.data.impl.PathImpl
		 * @see de.dfki.iui.basys.model.data.impl.DataPackageImpl#getPath()
