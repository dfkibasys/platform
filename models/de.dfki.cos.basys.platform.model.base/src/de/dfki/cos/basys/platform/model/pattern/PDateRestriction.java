 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.PDateRestriction#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPDateRestriction()
 * @model superTypes="de.dfki.cos.basys.platform.model.pattern.PNumberRestriction&lt;org.eclipse.emf.ecore.EDate&gt;"
 * @generated
 */
public interface PDateRestriction extends PNumberRestriction<Date> {
	 ...
	 * @see #setValue(Date)
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPDateRestriction_Value()
	 * @model
	 * @generated
	 */
	Date getValue();
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.pattern.PDateRestriction#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
