 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.PNumberRestriction#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPNumberRestriction()
 * @model abstract="true"
 * @generated
 */
public interface PNumberRestriction<V> extends PRestriction<PNumberRestrictionEnum, V> {
	 ...
	 * The literals are from the enumeration {@link de.dfki.cos.basys.platform.model.pattern.PNumberRestrictionEnum}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPNumberRestriction_Function()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.pattern.PNumberRestriction#getFunction <em>Function</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
