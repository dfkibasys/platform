 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.impl.PStringRestrictionImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.impl.PStringRestrictionImpl#isIgnoreCase <em>Ignore Case</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.impl.PStringRestrictionImpl#getValue <em>Value</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.impl.PStringRestrictionImpl#getFunction <em>Function</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PStringRestrictionImpl extends BasysEObjectImpl implements PStringRestriction {
	/**
	...
	public boolean isSatisfiedBy(final Object value) {
		if (value instanceof String || value instanceof de.dfki.cos.basys.platform.model.base.datatypes.BString) {
