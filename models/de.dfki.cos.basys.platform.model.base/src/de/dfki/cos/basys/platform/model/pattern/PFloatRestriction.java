 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.PFloatRestriction#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPFloatRestriction()
 * @model superTypes="de.dfki.cos.basys.platform.model.pattern.PNumberRestriction&lt;de.dfki.cos.basys.platform.model.base.BFloat&gt;"
 * @generated
 */
public interface PFloatRestriction extends PNumberRestriction<BFloat> {
	 ...
	 * @see #setValue(BFloat)
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPFloatRestriction_Value()
	 * @model dataType="de.dfki.cos.basys.platform.model.base.BFloat"
	 * @generated
	 */
	BFloat getValue();

	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.pattern.PFloatRestriction#getValue <em>Value</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
