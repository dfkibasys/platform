 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.PEnumRestriction#getFunction <em>Function</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.PEnumRestriction#getValue <em>Value</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.PEnumRestriction#getEnumDataType <em>Enum Data Type</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPEnumRestriction()
 * @model superTypes="de.dfki.cos.basys.platform.model.pattern.PRestriction&lt;de.dfki.cos.basys.platform.model.pattern.PEnumRestrictionEnum, org.eclipse.emf.ecore.EJavaObject&gt;"
 * @generated
 */
public interface PEnumRestriction extends PRestriction<PEnumRestrictionEnum, Object> {
	/**
	 * Returns the value of the '<em><b>Function</b></em>' attribute.
	 * The literals are from the enumeration {@link de.dfki.cos.basys.platform.model.pattern.PEnumRestrictionEnum}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPEnumRestriction_Function()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.pattern.PEnumRestriction#getFunction <em>Function</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPEnumRestriction_Value()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.pattern.PEnumRestriction#getValue <em>Value</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPEnumRestriction_EnumDataType()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.pattern.PEnumRestriction#getEnumDataType <em>Enum Data Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
