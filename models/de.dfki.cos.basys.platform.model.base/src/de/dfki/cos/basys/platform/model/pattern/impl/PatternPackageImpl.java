...
import de.dfki.cos.basys.platform.model.data.impl.DataPackageImpl;
import de.dfki.cos.basys.platform.model.pattern.Computation;
...
import de.dfki.cos.basys.platform.model.pattern.PByteRestriction;
import de.dfki.cos.basys.platform.model.pattern.PCharRestriction;
import de.dfki.cos.basys.platform.model.pattern.PCharRestrictionEnum;
import de.dfki.cos.basys.platform.model.pattern.PDateRestriction;
import de.dfki.cos.basys.platform.model.pattern.PDoubleRestriction;
import de.dfki.cos.basys.platform.model.pattern.PEmptySlot;
import de.dfki.cos.basys.platform.model.pattern.PEnumRestriction;
import de.dfki.cos.basys.platform.model.pattern.PEnumRestrictionEnum;
import de.dfki.cos.basys.platform.model.pattern.PEnumRestrictionType;
import de.dfki.cos.basys.platform.model.pattern.PFloatRestriction;
import de.dfki.cos.basys.platform.model.pattern.PIntegerRestriction;
import de.dfki.cos.basys.platform.model.pattern.PLongRestriction;
import de.dfki.cos.basys.platform.model.pattern.PNumberRestriction;
import de.dfki.cos.basys.platform.model.pattern.PNumberRestrictionEnum;
import de.dfki.cos.basys.platform.model.pattern.PObject;
import de.dfki.cos.basys.platform.model.pattern.PPattern;
import de.dfki.cos.basys.platform.model.pattern.PQuantorEnum;
import de.dfki.cos.basys.platform.model.pattern.PRestriction;
import de.dfki.cos.basys.platform.model.pattern.PRestrictions;
import de.dfki.cos.basys.platform.model.pattern.PRestrictionsEnum;
import de.dfki.cos.basys.platform.model.pattern.PShortRestriction;
import de.dfki.cos.basys.platform.model.pattern.PSlot;
import de.dfki.cos.basys.platform.model.pattern.PStringRestriction;
import de.dfki.cos.basys.platform.model.pattern.PStringRestrictionEnum;
import de.dfki.cos.basys.platform.model.pattern.PValue;
import de.dfki.cos.basys.platform.model.pattern.PValueGen;
import de.dfki.cos.basys.platform.model.pattern.PValueObject;
import de.dfki.cos.basys.platform.model.pattern.PatternFactory;
...
public class PatternPackageImpl extends EPackageImpl implements PatternPackage {
	 ...
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
