 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.PPattern#getVarName <em>Var Name</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.PPattern#getInstIdx <em>Inst Idx</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.pattern.PPattern#getQuantor <em>Quantor</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPPattern()
 * @model abstract="true"
 * @generated
 */
public interface PPattern extends EObject {
	 ...
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPPattern_VarName()
	 * @model
	 * @generated
	 */
	String getVarName();
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.pattern.PPattern#getVarName <em>Var Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see #setInstIdx(int)
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPPattern_InstIdx()
	 * @model default="-1"
	 * @generated
	 */
	int getInstIdx();
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.pattern.PPattern#getInstIdx <em>Inst Idx</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The literals are from the enumeration {@link de.dfki.cos.basys.platform.model.pattern.PQuantorEnum}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.pattern.PatternPackage#getPPattern_Quantor()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.pattern.PPattern#getQuantor <em>Quantor</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
