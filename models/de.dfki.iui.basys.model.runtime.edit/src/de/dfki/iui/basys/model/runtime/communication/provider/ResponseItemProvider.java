...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.runtime.communication.Response} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ResponseItemProvider extends MessageItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Response_requestId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Response_requestId_feature", "_UI_Response_type"),
				 CommunicationPackage.Literals.RESPONSE__REQUEST_ID,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((Response)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Response.class)) {
			case CommunicationPackage.RESPONSE__REQUEST_ID:
