...
public class PatternActionBarContributor
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("pattern-settings"));
		toolBarManager.add(new Separator("pattern-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(BaseEditorPlugin.INSTANCE.getString("_UI_PatternEditor_menu"), "de.dfki.cos.basys.platform.model.patternMenuID");
