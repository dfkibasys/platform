 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.communication.impl.ChannelImpl#getListener <em>Listener</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.communication.impl.ChannelImpl#getPool <em>Pool</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.communication.impl.ChannelImpl#isOpen <em>Open</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.communication.impl.ChannelImpl#isQueued <em>Queued</em>}</li>
 * </ul>
 *
 * @generated
 */
...
//			eNotify(new ENotificationImpl(this, Notification.SET, CommunicationPackage.CHANNEL__LISTENER, oldListener, listener));
	 ...
	 * @generated NOT
	 */
	public void sendNotification(de.dfki.cos.basys.platform.model.runtime.communication.Notification not) throws ChannelException {
		if (!isOpen())
			throw new ChannelException("Channel not open");
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			...
			case CommunicationPackage.CHANNEL___SEND_NOTIFICATION__NOTIFICATION:
				try {
					sendNotification((de.dfki.cos.basys.platform.model.runtime.communication.Notification)arguments.get(0));
					return null;
				}
				catch (Throwable throwable) {
					throw new InvocationTargetException(throwable);
