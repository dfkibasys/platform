 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getComponentId <em>Component Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getComponentName <em>Component Name</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getComponentCategory <em>Component Category</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getComponentImplementationJavaClass <em>Component Implementation Java Class</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getCommunicationProviderImplementationJavaClass <em>Communication Provider Implementation Java Class</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getCommunicationProviderConnectionString <em>Communication Provider Connection String</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getInChannelName <em>In Channel Name</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getOutChannelName <em>Out Channel Name</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getExternalConnectionString <em>External Connection String</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getProperties <em>Properties</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.ComponentConfigurationImpl#getSimulationConfiguration <em>Simulation Configuration</em>}</li>
 * </ul>
 *
 * @generated
 */
