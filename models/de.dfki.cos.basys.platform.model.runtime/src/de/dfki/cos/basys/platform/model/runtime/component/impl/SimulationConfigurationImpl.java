 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnResettingDuration <em>On Resetting Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnStartingDuration <em>On Starting Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnExecuteDuration <em>On Execute Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnCompletingDuration <em>On Completing Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnStoppingDuration <em>On Stopping Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnAbortingDuration <em>On Aborting Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnClearingDuration <em>On Clearing Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnHoldingDuration <em>On Holding Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnUnholdingDuration <em>On Unholding Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnSuspendingDuration <em>On Suspending Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnUnsuspendingDuration <em>On Unsuspending Duration</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnCompletingVariables <em>On Completing Variables</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnCompletingStatusCode <em>On Completing Status Code</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.impl.SimulationConfigurationImpl#getOnStoppingStatusCode <em>On Stopping Status Code</em>}</li>
 * </ul>
 *
 * @generated
 */
