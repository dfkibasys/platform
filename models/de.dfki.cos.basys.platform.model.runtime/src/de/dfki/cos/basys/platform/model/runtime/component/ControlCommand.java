...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Control Command</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see de.dfki.cos.basys.platform.model.runtime.component.ComponentPackage#getControlCommand()
 * @model
 * @generated
 */
public enum ControlCommand implements Enumerator {
	/**
	...
	/**
	 * An array of all the '<em><b>Control Command</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	private static final ControlCommand[] VALUES_ARRAY =
		new ControlCommand[] {
			NO_COMMAND,
			RESET,
			START,
	...
	/**
	 * A public read-only list of all the '<em><b>Control Command</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<ControlCommand> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Control Command</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ControlCommand get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ControlCommand result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Control Command</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static ControlCommand getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			ControlCommand result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Control Command</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static ControlCommand get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private ControlCommand(int value, String name, String literal) {
		this.value = value;
		this.name = name;
