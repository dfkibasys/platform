 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.ComponentResponse#getComponentId <em>Component Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.runtime.component.ComponentResponse#getStatus <em>Status</em>}</li>
...
public interface ComponentResponse extends EObject {
	 ...
	 * @see de.dfki.cos.basys.platform.model.runtime.component.ComponentPackage#getComponentResponse_ComponentId()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.runtime.component.ComponentResponse#getComponentId <em>Component Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.runtime.component.ComponentPackage#getComponentResponse_Status()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.runtime.component.ComponentResponse#getStatus <em>Status</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.runtime.component.ComponentPackage#getComponentResponse_StatusCode()
	 * @model
	 * @generated
	 */
	int getStatusCode();
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.runtime.component.ComponentResponse#getStatusCode <em>Status Code</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.runtime.component.ComponentPackage#getComponentResponse_Message()
	 * @model
	 * @generated
	 */
	String getMessage();
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.runtime.component.ComponentResponse#getMessage <em>Message</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.runtime.component.ComponentPackage#getComponentResponse_Request()
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.runtime.component.ComponentResponse#getRequest <em>Request</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
