 ...
 * @generated
 */
public class OccupationLevelRequestItemProvider 
	 ...
	 * @generated
	 */
	public OccupationLevelRequestItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addOccupationLevelPropertyDescriptor(object);
		}
	...
	/**
	 * This adds a property descriptor for the Occupation Level feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addOccupationLevelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_OccupationLevelRequest_occupationLevel_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_OccupationLevelRequest_occupationLevel_feature", "_UI_OccupationLevelRequest_type"),
				 ComponentPackage.Literals.OCCUPATION_LEVEL_REQUEST__OCCUPATION_LEVEL,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	/**
	 * This returns OccupationLevelRequest.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/OccupationLevelRequest"));
	}
	...
	public String getText(Object object) {
		String label = ((OccupationLevelRequest)object).getComponentId();
		return label == null || label.length() == 0 ?
			getString("_UI_OccupationLevelRequest_type") :
			getString("_UI_OccupationLevelRequest_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(OccupationLevelRequest.class)) {
