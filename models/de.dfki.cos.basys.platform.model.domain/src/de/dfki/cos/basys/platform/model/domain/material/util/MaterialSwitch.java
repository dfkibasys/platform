...
public class MaterialSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case MaterialPackage.MATERIAL_CATALOGUE: {
				MaterialCatalogue materialCatalogue = (MaterialCatalogue)theEObject;
				T result = caseMaterialCatalogue(materialCatalogue);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaterialPackage.MATERIAL_GROUP: {
				MaterialGroup materialGroup = (MaterialGroup)theEObject;
				T result = caseMaterialGroup(materialGroup);
				if (result == null) result = caseEntity(materialGroup);
				if (result == null) result = caseBObject(materialGroup);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case MaterialPackage.MATERIAL: {
	 ...
	 * @generated
	 */
	public T caseMaterialCatalogue(MaterialCatalogue object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseMaterialGroup(MaterialGroup object) {
		return null;
	}
