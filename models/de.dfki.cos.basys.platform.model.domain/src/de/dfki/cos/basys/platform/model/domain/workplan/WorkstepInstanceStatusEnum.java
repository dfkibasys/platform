...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Workstep Instance Status Enum</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see de.dfki.cos.basys.platform.model.domain.workplan.WorkplanPackage#getWorkstepInstanceStatusEnum()
 * @model
 * @generated
 */
public enum WorkstepInstanceStatusEnum implements Enumerator {
	/**
	 ...
	 * @generated
	 */
	private static final WorkstepInstanceStatusEnum[] VALUES_ARRAY =
		new WorkstepInstanceStatusEnum[] {
			UNKNOWN,
			STARTED,
			PAUSED,
			REPEATING,
	...
	/**
	 * A public read-only list of all the '<em><b>Workstep Instance Status Enum</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<WorkstepInstanceStatusEnum> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Workstep Instance Status Enum</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static WorkstepInstanceStatusEnum get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			WorkstepInstanceStatusEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Workstep Instance Status Enum</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static WorkstepInstanceStatusEnum getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			WorkstepInstanceStatusEnum result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Workstep Instance Status Enum</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static WorkstepInstanceStatusEnum get(int value) {
		switch (value) {
	 ...
	 * @generated
	 */
	private WorkstepInstanceStatusEnum(int value, String name, String literal) {
		this.value = value;
		this.name = name;
