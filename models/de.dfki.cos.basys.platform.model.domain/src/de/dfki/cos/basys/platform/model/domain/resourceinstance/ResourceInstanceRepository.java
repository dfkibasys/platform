 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceInstanceRepository#getResourceInstances <em>Resource Instances</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceinstancePackage#getResourceInstanceRepository()
 * @model
 * @generated
 */
public interface ResourceInstanceRepository extends EObject {
	 ...
	 * The list contents are of type {@link de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceInstance}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceinstancePackage#getResourceInstanceRepository_ResourceInstances()
