/**
 */
package de.dfki.cos.basys.platform.model.domain.staff.impl;

import de.dfki.cos.basys.platform.model.base.impl.EntityImpl;
import de.dfki.cos.basys.platform.model.domain.staff.Staff;
 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.staff.impl.StaffImpl#getFirstname <em>Firstname</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.staff.impl.StaffImpl#getLastname <em>Lastname</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.staff.impl.StaffImpl#getBirthdate <em>Birthdate</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.staff.impl.StaffImpl#getLanguage <em>Language</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StaffImpl extends EntityImpl implements Staff {
	...
	public void setFirstname(String newFirstname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaffPackage.STAFF__FIRSTNAME, oldFirstname, firstname));
	}
	...
	public void setLastname(String newLastname) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaffPackage.STAFF__LASTNAME, oldLastname, lastname));
	}
	...
	public void setBirthdate(Date newBirthdate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaffPackage.STAFF__BIRTHDATE, oldBirthdate, birthdate));
	}
	...
	public void setLanguage(String newLanguage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StaffPackage.STAFF__LANGUAGE, oldLanguage, language));
	}
