 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.processdefinition.impl.DataImpl#getAvailableOn <em>Available On</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.processdefinition.impl.DataImpl#getTaskRef <em>Task Ref</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.processdefinition.impl.DataImpl#getPattern <em>Pattern</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.processdefinition.impl.DataImpl#getInstance <em>Instance</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.processdefinition.impl.DataImpl#getMappings <em>Mappings</em>}</li>
 * </ul>
 *
 * @generated
 */
