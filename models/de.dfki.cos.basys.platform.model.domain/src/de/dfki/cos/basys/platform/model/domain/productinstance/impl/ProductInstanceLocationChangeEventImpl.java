...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Product Instance Location Change Event</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.productinstance.impl.ProductInstanceLocationChangeEventImpl#getTimestamp <em>Timestamp</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ProductInstanceLocationChangeEventImpl extends ProductInstanceLocationImpl implements ProductInstanceLocationChangeEvent {
	...
	protected EClass eStaticClass() {
		return ProductinstancePackage.Literals.PRODUCT_INSTANCE_LOCATION_CHANGE_EVENT;
	}
	...
	public void setTimestamp(Date newTimestamp) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProductinstancePackage.PRODUCT_INSTANCE_LOCATION_CHANGE_EVENT__TIMESTAMP, oldTimestamp, timestamp));
	}
