 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workerguidance.impl.MediaImpl#getType <em>Type</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workerguidance.impl.MediaImpl#getFileSize <em>File Size</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workerguidance.impl.MediaImpl#getChecksum <em>Checksum</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workerguidance.impl.MediaImpl#getLocation <em>Location</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workerguidance.impl.MediaImpl#getEntityType <em>Entity Type</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workerguidance.impl.MediaImpl#getEntityIds <em>Entity Ids</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workerguidance.impl.MediaImpl#getTags <em>Tags</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workerguidance.impl.MediaImpl#getLocale <em>Locale</em>}</li>
 * </ul>
 *
 * @generated
 */
