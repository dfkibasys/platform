/**
 */
package de.dfki.cos.basys.platform.model.domain.order.util;

import de.dfki.cos.basys.platform.model.base.BObject;
import de.dfki.cos.basys.platform.model.base.Entity;
import de.dfki.cos.basys.platform.model.domain.order.*;
 ...
 * <!-- end-user-doc -->
 * @see de.dfki.cos.basys.platform.model.domain.order.OrderPackage
 * @generated
 */
public class OrderAdapterFactory extends AdapterFactoryImpl {
	/**
	...
	public OrderAdapterFactory() {
		if (modelPackage == null) {
			modelPackage = OrderPackage.eINSTANCE;
		}
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.cos.basys.platform.model.domain.order.Order <em>Order</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.cos.basys.platform.model.domain.order.OrderStatus <em>Status</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.cos.basys.platform.model.domain.order.OrderStatusChangeEvent <em>Status Change Event</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.cos.basys.platform.model.domain.order.OrderStore <em>Store</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
