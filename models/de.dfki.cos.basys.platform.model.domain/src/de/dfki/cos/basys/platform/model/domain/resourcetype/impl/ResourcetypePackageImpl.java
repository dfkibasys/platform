...
import de.dfki.cos.basys.platform.model.domain.resourcetype.BeltConveyor;
import de.dfki.cos.basys.platform.model.domain.resourcetype.BodyStore;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Carrier;
import de.dfki.cos.basys.platform.model.domain.resourcetype.CarrierHandlingSystem;
import de.dfki.cos.basys.platform.model.domain.resourcetype.ChainConveyor;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Clamp;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Conveyor;
import de.dfki.cos.basys.platform.model.domain.resourcetype.DiscreteManufacturingEquipmentModule;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Fixture;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Gate;
import de.dfki.cos.basys.platform.model.domain.resourcetype.HorizontalTransport;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Lift;
import de.dfki.cos.basys.platform.model.domain.resourcetype.LiftingTable;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Loader;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Machine;
import de.dfki.cos.basys.platform.model.domain.resourcetype.MovableTool;
import de.dfki.cos.basys.platform.model.domain.resourcetype.OverheadConveyor;
import de.dfki.cos.basys.platform.model.domain.resourcetype.PalletConveyor;
...
import de.dfki.cos.basys.platform.model.domain.resourcetype.Robot;
import de.dfki.cos.basys.platform.model.domain.resourcetype.RollConveyor;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Rollerbed;
import de.dfki.cos.basys.platform.model.domain.resourcetype.StaticObject;
import de.dfki.cos.basys.platform.model.domain.resourcetype.StationaryTool;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Storage;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Tool;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Transport;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Transposer;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Turnable;
import de.dfki.cos.basys.platform.model.domain.resourcetype.Unloader;
import de.dfki.cos.basys.platform.model.domain.resourcetype.VerticalTransport;
...
public class ResourcetypePackageImpl extends EPackageImpl implements ResourcetypePackage {
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.resourcetype.ResourcetypePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEClass(avgEClass, de.dfki.cos.basys.platform.model.domain.resourcetype.AVG.class, "AVG", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
