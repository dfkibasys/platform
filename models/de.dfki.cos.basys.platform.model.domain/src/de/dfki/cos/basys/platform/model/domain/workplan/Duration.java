 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workplan.Duration#getWorkstepInstanceId <em>Workstep Instance Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workplan.Duration#getAgentId <em>Agent Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workplan.Duration#getAverage <em>Average</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workplan.Duration#getStandardDeviation <em>Standard Deviation</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.workplan.WorkplanPackage#getDuration()
 * @model
 * @generated
 */
public interface Duration extends Entity {
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.workplan.WorkplanPackage#getDuration_WorkstepInstanceId()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.workplan.Duration#getWorkstepInstanceId <em>Workstep Instance Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.workplan.WorkplanPackage#getDuration_AgentId()
	 * @model
	 * @generated
	 */
	String getAgentId();
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.workplan.Duration#getAgentId <em>Agent Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.workplan.WorkplanPackage#getDuration_Average()
	 * @model
	 * @generated
	 */
	double getAverage();
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.workplan.Duration#getAverage <em>Average</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.workplan.WorkplanPackage#getDuration_StandardDeviation()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.workplan.Duration#getStandardDeviation <em>Standard Deviation</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
