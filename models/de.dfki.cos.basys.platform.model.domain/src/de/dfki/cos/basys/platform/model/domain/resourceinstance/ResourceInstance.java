 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceInstance#getSerialNumber <em>Serial Number</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceInstance#getResourceType <em>Resource Type</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceInstance#getCapabilityApplications <em>Capability Applications</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceInstance#getRole <em>Role</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceinstancePackage#getResourceInstance()
 * @model
 * @generated
 */
public interface ResourceInstance extends Entity {
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceinstancePackage#getResourceInstance_SerialNumber()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceInstance#getSerialNumber <em>Serial Number</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceinstancePackage#getResourceInstance_ResourceType()
	 * @model required="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceInstance#getResourceType <em>Resource Type</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceinstancePackage#getResourceInstance_CapabilityApplications()
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.resourceinstance.ResourceInstance#getRole <em>Role</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
