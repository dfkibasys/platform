...
public class CapabilitySwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CapabilityPackage.TAKE: {
				Take take = (Take)theEObject;
				T result = caseTake(take);
				if (result == null) result = caseGeneralCapability(take);
				if (result == null) result = caseCapability(take);
				if (result == null) result = caseEntity(take);
				if (result == null) result = caseBObject(take);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CapabilityPackage.TEST_CAPABILITY: {
				TestCapability testCapability = (TestCapability)theEObject;
				T result = caseTestCapability(testCapability);
				if (result == null) result = caseCapability(testCapability);
				if (result == null) result = caseEntity(testCapability);
				if (result == null) result = caseBObject(testCapability);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Test Capability</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Test Capability</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseTestCapability(TestCapability object) {
		return null;
	}
