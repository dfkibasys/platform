...
public interface ProductinstanceFactory extends EFactory {
	 ...
	 * @generated
	 */
	ProductinstanceFactory eINSTANCE = de.dfki.cos.basys.platform.model.domain.productinstance.impl.ProductinstanceFactoryImpl.init();
	...
	/**
	 * Returns a new object of class '<em>Product Instance Store</em>'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return a new object of class '<em>Product Instance Store</em>'.
	 * @generated
	 */
	ProductInstanceStore createProductInstanceStore();
