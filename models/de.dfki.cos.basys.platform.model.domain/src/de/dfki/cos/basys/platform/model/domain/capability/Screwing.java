 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.capability.Screwing#getTorque <em>Torque</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.capability.CapabilityPackage#getScrewing()
 * @model
 * @generated
 */
public interface Screwing extends AnEinpressen {
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.capability.CapabilityPackage#getScrewing_Torque()
	 * @model
	 * @generated
	 */
	double getTorque();
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.capability.Screwing#getTorque <em>Torque</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
