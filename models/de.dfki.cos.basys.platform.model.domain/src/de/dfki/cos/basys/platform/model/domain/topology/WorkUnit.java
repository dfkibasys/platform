 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.topology.WorkUnit#getEquipmentModules <em>Equipment Modules</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.topology.TopologyPackage#getWorkUnit()
 * @model abstract="true"
 * @generated
 */
public interface WorkUnit extends TopologyElement {
	/**
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.topology.TopologyPackage#getWorkUnit_EquipmentModules()
