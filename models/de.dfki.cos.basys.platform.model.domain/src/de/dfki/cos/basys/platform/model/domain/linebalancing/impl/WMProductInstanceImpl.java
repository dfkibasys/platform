 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.linebalancing.impl.WMProductInstanceImpl#getSerialId <em>Serial Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.linebalancing.impl.WMProductInstanceImpl#getPosition <em>Position</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.linebalancing.impl.WMProductInstanceImpl#isIn_transit <em>In transit</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.linebalancing.impl.WMProductInstanceImpl#getEta <em>Eta</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.linebalancing.impl.WMProductInstanceImpl#getVariant <em>Variant</em>}</li>
 * </ul>
 *
 * @generated
 */
