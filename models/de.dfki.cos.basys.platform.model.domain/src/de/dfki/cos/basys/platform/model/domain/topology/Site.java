 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.topology.Site#getAreas <em>Areas</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.topology.TopologyPackage#getSite()
 * @model
 * @generated
 */
public interface Site extends TopologyElement {
	 ...
	 * The list contents are of type {@link de.dfki.cos.basys.platform.model.domain.topology.Area}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.topology.TopologyPackage#getSite_Areas()
