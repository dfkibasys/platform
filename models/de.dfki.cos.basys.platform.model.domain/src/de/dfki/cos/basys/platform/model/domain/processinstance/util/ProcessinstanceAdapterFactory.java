/**
 */
package de.dfki.cos.basys.platform.model.domain.processinstance.util;
...
public class ProcessinstanceAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.cos.basys.platform.model.domain.processinstance.ProcessInstance <em>Process Instance</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.cos.basys.platform.model.domain.processinstance.TaskInstance <em>Task Instance</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.cos.basys.platform.model.domain.processinstance.ProcessInstanceStore <em>Process Instance Store</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
