 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.capability.impl.ProjectPathImpl#getPath <em>Path</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.capability.impl.ProjectPathImpl#getDelay <em>Delay</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.capability.impl.ProjectPathImpl#getArrowCount <em>Arrow Count</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.capability.impl.ProjectPathImpl#getColor <em>Color</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.capability.impl.ProjectPathImpl#getEta <em>Eta</em>}</li>
 * </ul>
 *
 * @generated
 */
