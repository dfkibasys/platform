 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workplan.WorkplanInstance#getProductInstanceId <em>Product Instance Id</em>}</li>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workplan.WorkplanInstance#getWorkstepInstances <em>Workstep Instances</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.workplan.WorkplanPackage#getWorkplanInstance()
 * @model
 * @generated
 */
public interface WorkplanInstance extends Entity {
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.workplan.WorkplanPackage#getWorkplanInstance_ProductInstanceId()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.workplan.WorkplanInstance#getProductInstanceId <em>Product Instance Id</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * The list contents are of type {@link de.dfki.cos.basys.platform.model.domain.workplan.WorkstepInstance}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.workplan.WorkplanPackage#getWorkplanInstance_WorkstepInstances()
