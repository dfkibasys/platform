 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.topology.WorkCell#getStations <em>Stations</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.topology.TopologyPackage#getWorkCell()
 * @model
 * @generated
 */
public interface WorkCell extends WorkUnit {
	 ...
	 * The list contents are of type {@link de.dfki.cos.basys.platform.model.domain.topology.Station}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.topology.TopologyPackage#getWorkCell_Stations()
