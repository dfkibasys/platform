 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.productdefinition.ManufacturedComponent#getBom <em>Bom</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.productdefinition.ProductdefinitionPackage#getManufacturedComponent()
...
public interface ManufacturedComponent extends Entity {
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.productdefinition.ProductdefinitionPackage#getManufacturedComponent_Bom()
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.productdefinition.ManufacturedComponent#getBom <em>Bom</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
