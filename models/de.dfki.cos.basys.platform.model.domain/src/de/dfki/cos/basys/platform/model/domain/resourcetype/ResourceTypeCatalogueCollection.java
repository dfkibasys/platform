 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.resourcetype.ResourceTypeCatalogueCollection#getCatalogues <em>Catalogues</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.resourcetype.ResourcetypePackage#getResourceTypeCatalogueCollection()
 * @model
 * @generated
 */
public interface ResourceTypeCatalogueCollection extends EObject {
	 ...
	 * The list contents are of type {@link de.dfki.cos.basys.platform.model.domain.resourcetype.ResourceTypeCatalogue}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.resourcetype.ResourcetypePackage#getResourceTypeCatalogueCollection_Catalogues()
