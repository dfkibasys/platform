...
import de.dfki.cos.basys.platform.model.domain.processdefinition.DataFlow;
import de.dfki.cos.basys.platform.model.domain.processdefinition.DataMapping;
import de.dfki.cos.basys.platform.model.domain.processdefinition.DataTransformation;
import de.dfki.cos.basys.platform.model.domain.processdefinition.Edge;
import de.dfki.cos.basys.platform.model.domain.processdefinition.FlowNode;
import de.dfki.cos.basys.platform.model.domain.processdefinition.Gateway;
import de.dfki.cos.basys.platform.model.domain.processdefinition.GatewayTypeEnum;
import de.dfki.cos.basys.platform.model.domain.processdefinition.Node;
...
import de.dfki.cos.basys.platform.model.domain.processdefinition.TaskDependency;
import de.dfki.cos.basys.platform.model.domain.processdefinition.TaskExecuting;
import de.dfki.cos.basys.platform.model.domain.processdefinition.TaskFailed;
...
import de.dfki.cos.basys.platform.model.domain.processdefinition.TaskPaused;
...
import de.dfki.cos.basys.platform.model.domain.processdefinition.util.ProcessdefinitionValidator;
...
public class ProcessdefinitionPackageImpl extends EPackageImpl implements ProcessdefinitionPackage {
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.processdefinition.ProcessdefinitionPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static ProcessdefinitionPackage init() {
		if (isInited) return (ProcessdefinitionPackage)EPackage.Registry.INSTANCE.getEPackage(ProcessdefinitionPackage.eNS_URI);

		// Obtain or create and register package
		ProcessdefinitionPackageImpl theProcessdefinitionPackage = (ProcessdefinitionPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof ProcessdefinitionPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new ProcessdefinitionPackageImpl());
		...
		EValidator.Registry.INSTANCE.put
			(theProcessdefinitionPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return ProcessdefinitionValidator.INSTANCE;
				 }
			 });
	...
	public void initializePackageContents() {
		...
		initEReference(getProcessDefinition_ProductVariant(), theProductdefinitionPackage.getProductVariant(), null, "productVariant", null, 0, 1, ProcessDefinition.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getUsedMaterial_BomEntry(), theProductdefinitionPackage.getBOMEntry(), null, "bomEntry", null, 1, 1, UsedMaterial.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
