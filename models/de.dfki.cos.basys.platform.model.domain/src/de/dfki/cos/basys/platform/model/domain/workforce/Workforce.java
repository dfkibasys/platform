 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.workforce.Workforce#getAgents <em>Agents</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.workforce.WorkforcePackage#getWorkforce()
 * @model
 * @generated
 */
public interface Workforce extends EObject {
	 ...
	 * The list contents are of type {@link de.dfki.cos.basys.platform.model.domain.workforce.Agent}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.workforce.WorkforcePackage#getWorkforce_Agents()
