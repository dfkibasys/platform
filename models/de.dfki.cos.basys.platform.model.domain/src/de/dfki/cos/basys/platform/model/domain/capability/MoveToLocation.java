 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.capability.MoveToLocation#getTargetLocation <em>Target Location</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.capability.CapabilityPackage#getMoveToLocation()
 * @model
 * @generated
 */
public interface MoveToLocation extends GeneralCapability {
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.capability.CapabilityPackage#getMoveToLocation_TargetLocation()
	 * @model
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.cos.basys.platform.model.domain.capability.MoveToLocation#getTargetLocation <em>Target Location</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
