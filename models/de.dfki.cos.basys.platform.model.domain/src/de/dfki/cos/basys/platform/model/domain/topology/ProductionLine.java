 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.cos.basys.platform.model.domain.topology.ProductionLine#getWorkCells <em>Work Cells</em>}</li>
 * </ul>
 *
 * @see de.dfki.cos.basys.platform.model.domain.topology.TopologyPackage#getProductionLine()
 * @model
 * @generated
 */
public interface ProductionLine extends WorkCenter {
	 ...
	 * The list contents are of type {@link de.dfki.cos.basys.platform.model.domain.topology.WorkCell}.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.cos.basys.platform.model.domain.topology.TopologyPackage#getProductionLine_WorkCells()
