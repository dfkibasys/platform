...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.domain.capability.Transport} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TransportItemProvider extends LogisticsCapabilityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Transport_distance_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Transport_distance_feature", "_UI_Transport_type"),
				 CapabilityPackage.Literals.TRANSPORT__DISTANCE,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Transport.class)) {
			case CapabilityPackage.TRANSPORT__DISTANCE:
