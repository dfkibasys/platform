...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.domain.processdefinition.TaskDependency} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProcessdefinitionPackage.Literals.TASK_DEPENDENCY__SOURCE_STATE,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProcessdefinitionPackage.Literals.TASK_DEPENDENCY__TARGET_STATE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
