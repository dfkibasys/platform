...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.domain.capability.ProjectETA} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ProjectETAItemProvider extends WorkerAssistenceCapabilityItemProvider {
	/**
	 ...
	 * @generated
	 */
	public ProjectETAItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProjectETA_eta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProjectETA_eta_feature", "_UI_ProjectETA_type"),
				 CapabilityPackage.Literals.PROJECT_ETA__ETA,
				 true,
				 false,
				 false,
	...
	protected void addRadiusPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ProjectETA_radius_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ProjectETA_radius_feature", "_UI_ProjectETA_type"),
				 CapabilityPackage.Literals.PROJECT_ETA__RADIUS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CapabilityPackage.Literals.PROJECT_ETA__POSITION);
		}
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ProjectETA"));
	}
	...
	public String getText(Object object) {
		String label = ((ProjectETA)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_ProjectETA_type") :
			getString("_UI_ProjectETA_type") + " " + label;
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ProjectETA.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(CapabilityPackage.Literals.PROJECT_ETA__POSITION,
