...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.domain.processdefinition.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EdgeItemProvider extends EntityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_sourceRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_sourceRef_feature", "_UI_Edge_type"),
				 ProcessdefinitionPackage.Literals.EDGE__SOURCE_REF,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addTargetRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Edge_targetRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Edge_targetRef_feature", "_UI_Edge_type"),
				 ProcessdefinitionPackage.Literals.EDGE__TARGET_REF,
				 true,
				 false,
				 true,
				 null,
