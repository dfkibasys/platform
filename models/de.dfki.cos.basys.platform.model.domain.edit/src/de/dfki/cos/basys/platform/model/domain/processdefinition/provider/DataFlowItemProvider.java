...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.domain.processdefinition.DataFlow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataFlowItemProvider extends EdgeItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_DataFlow_transformation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_DataFlow_transformation_feature", "_UI_DataFlow_type"),
				 ProcessdefinitionPackage.Literals.DATA_FLOW__TRANSFORMATION,
				 true,
				 false,
				 true,
				 null,
