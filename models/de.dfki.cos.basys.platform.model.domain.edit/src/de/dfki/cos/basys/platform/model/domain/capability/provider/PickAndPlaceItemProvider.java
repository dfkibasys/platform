...
/**
 * This is the item provider adapter for a {@link de.dfki.cos.basys.platform.model.domain.capability.PickAndPlace} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PickAndPlaceItemProvider extends LogisticsCapabilityItemProvider {
	/**
	 ...
	 * @generated
	 */
	public PickAndPlaceItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/PickAndPlace"));
	}
	...
	public String getText(Object object) {
		String label = ((PickAndPlace)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_PickAndPlace_type") :
			getString("_UI_PickAndPlace_type") + " " + label;
	}
