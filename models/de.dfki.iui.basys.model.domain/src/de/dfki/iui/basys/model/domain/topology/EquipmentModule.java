 ...
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.EquipmentModule#getCapabilityRequirement <em>Capability Requirement</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.EquipmentModule#getAssignedResourceType <em>Assigned Resource Type</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.topology.EquipmentModule#getAssignedResourceInstance <em>Assigned Resource Instance</em>}</li>
 * </ul>
 *
...
public interface EquipmentModule extends TopologyElement {
	 ...
	 * @see de.dfki.iui.basys.model.domain.topology.TopologyPackage#getEquipmentModule_CapabilityRequirement()
	 * @model containment="true"
	 * @generated
	 */
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.topology.EquipmentModule#getCapabilityRequirement <em>Capability Requirement</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.dfki.iui.basys.model.domain.resourceinstance.ResourceInstance#getRole <em>Role</em>}'.
	 * <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see de.dfki.iui.basys.model.domain.topology.TopologyPackage#getEquipmentModule_AssignedResourceInstance()
	...
	/**
	 * Sets the value of the '{@link de.dfki.iui.basys.model.domain.topology.EquipmentModule#getAssignedResourceInstance <em>Assigned Resource Instance</em>}' reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
