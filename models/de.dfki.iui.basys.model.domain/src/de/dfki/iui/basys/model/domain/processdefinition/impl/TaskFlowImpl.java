 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.domain.processdefinition.impl.TaskFlowImpl#getSourceState <em>Source State</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.processdefinition.impl.TaskFlowImpl#getTargetState <em>Target State</em>}</li>
 *   <li>{@link de.dfki.iui.basys.model.domain.processdefinition.impl.TaskFlowImpl#getCondition <em>Condition</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TaskFlowImpl extends EdgeImpl implements TaskFlow {
	...
	protected EClass eStaticClass() {
		return ProcessdefinitionPackage.Literals.TASK_FLOW;
	}
	...
	public void setSourceState(TaskStateEnum newSourceState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessdefinitionPackage.TASK_FLOW__SOURCE_STATE, oldSourceState, sourceState));
	}
	...
	public void setTargetState(TaskStateEnum newTargetState) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessdefinitionPackage.TASK_FLOW__TARGET_STATE, oldTargetState, targetState));
	}
	...
	public void setCondition(String newCondition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ProcessdefinitionPackage.TASK_FLOW__CONDITION, oldCondition, condition));
	}
