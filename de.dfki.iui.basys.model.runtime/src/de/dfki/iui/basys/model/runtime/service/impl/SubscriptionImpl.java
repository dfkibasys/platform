 ...
 * </p>
 * <ul>
 *   <li>{@link de.dfki.iui.basys.model.runtime.service.impl.SubscriptionImpl#getCapabilities <em>Capabilities</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubscriptionImpl extends ETypedElementImpl implements Subscription {
	...
	public EList<Capability> getCapabilities() {
		if (capabilities == null) {
			capabilities = new EObjectContainmentEList<Capability>(Capability.class, this, ServicePackage.SUBSCRIPTION__CAPABILITIES);
		}
		return capabilities;
	}
