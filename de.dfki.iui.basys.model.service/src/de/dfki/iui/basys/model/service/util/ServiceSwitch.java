	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ServicePackage.PUBLICATION: {
				...
				if (result == null) result = caseETypedElement(publication);
				if (result == null) result = caseENamedElement(publication);
				if (result == null) result = caseEModelElement(publication);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ServicePackage.SUBSCRIPTION: {
				...
				if (result == null) result = caseETypedElement(subscription);
				if (result == null) result = caseENamedElement(subscription);
				if (result == null) result = caseEModelElement(subscription);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
