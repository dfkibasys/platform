/**
 */
package de.dfki.iui.basys.model.aas.util;
...
public class AasAdapterFactory extends AdapterFactoryImpl {
	...
	protected AasSwitch<Adapter> modelSwitch =
		new AasSwitch<Adapter>() {
			@Override
			public Adapter caseAdministrationShell(AdministrationShell object) {
				return createAdministrationShellAdapter();
			}
			@Override
			public Adapter caseInformationMapping(InformationMapping object) {
				return createInformationMappingAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.iui.basys.model.aas.AdministrationShell <em>Administration Shell</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.iui.basys.model.aas.InformationMapping <em>Information Mapping</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.iui.basys.model.aas.ServiceCall <em>Service Call</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.dfki.iui.basys.model.aas.ParameterMapping <em>Parameter Mapping</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
