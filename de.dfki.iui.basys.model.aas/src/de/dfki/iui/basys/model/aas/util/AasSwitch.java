...
public class AasSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case AasPackage.INFORMATION_MAPPING: {
				InformationMapping informationMapping = (InformationMapping)theEObject;
				T result = caseInformationMapping(informationMapping);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AasPackage.SERVICE_CALL: {
				ServiceCall serviceCall = (ServiceCall)theEObject;
				T result = caseServiceCall(serviceCall);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case AasPackage.PARAMETER_MAPPING: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Administration Shell</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Administration Shell</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseAdministrationShell(AdministrationShell object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Information Mapping</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Information Mapping</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseInformationMapping(InformationMapping object) {
		return null;
	}
