...
public class JmsGatewayTest extends BaseComponentTest {
	...
	public void testInstallOutgoingChannel() {
		...
		JmsGatewayComponent gateway = (JmsGatewayComponent) componentManager.getComponentById("jms-gateway");
		gateway.installOutgoingChannel("test#gateway#out", "test.gateway.in");

		ChannelPool externalPool = CommFactory.getInstance().connectJmsChannelPool(communicationClient,
