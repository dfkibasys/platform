...
public class PathItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Path_eta_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Path_eta_feature", "_UI_Path_type"),
				 DataPackage.Literals.PATH__ETA,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Path_type") + " " + path.getEta();
	}
