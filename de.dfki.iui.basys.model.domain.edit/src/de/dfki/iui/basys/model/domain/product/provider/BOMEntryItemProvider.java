	...
	protected void addMaterialPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BOMEntry_material_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BOMEntry_material_feature", "_UI_BOMEntry_type"),
				 ProductPackage.Literals.BOM_ENTRY__MATERIAL,
				 true,
				 false,
				 true,
				 null,
