...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.domain.roletopology.Requirement} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RequirementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requirement_property_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_property_feature", "_UI_Requirement_type"),
				 RoletopologyPackage.Literals.REQUIREMENT__PROPERTY,
				 true,
				 false,
				 false,
	...
	protected void addValueRangePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requirement_valueRange_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_valueRange_feature", "_UI_Requirement_type"),
				 RoletopologyPackage.Literals.REQUIREMENT__VALUE_RANGE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addUnitPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Requirement_unit_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Requirement_unit_feature", "_UI_Requirement_type"),
				 RoletopologyPackage.Literals.REQUIREMENT__UNIT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Requirement)object).getProperty();
