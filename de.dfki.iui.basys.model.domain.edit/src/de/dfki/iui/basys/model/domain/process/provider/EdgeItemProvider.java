...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.domain.process.Edge} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProcessPackage.Literals.EDGE__SOURCE_REF,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ProcessPackage.Literals.EDGE__TARGET_REF,
				 true,
				 false,
				 true,
				 null,
