...
/**
 * This is the item provider adapter for a {@link de.dfki.iui.basys.model.domain.workerguidance.Material} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class MaterialItemProvider extends IdentifiableEntityItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WorkerguidancePackage.Literals.MATERIAL__NAME,
				 true,
				 false,
				 false,
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Material.class)) {
			case WorkerguidancePackage.MATERIAL__NAME:
