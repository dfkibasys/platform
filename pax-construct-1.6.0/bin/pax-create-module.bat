...
:help
echo pax-create-module [-g groupId] -a modulePath [-v version] [-o] [-- mvnOpts ...]
echo @ http://www.ops4j.org/projects/pax/construct/help/create-module.html
...
if ""=="%_ARTIFACTID_%" set _ARTIFACTID_=myModule
...
@echo on
mvn -N %PAX_PLUGIN%:create-module -DgroupId=%_GROUPID_% -DartifactId=%_ARTIFACTID_% -Dversion=%_VERSION_% %_EXTRA_%
:done
