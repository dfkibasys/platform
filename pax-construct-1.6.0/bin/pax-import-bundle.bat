...
:help
echo pax-import-bundle [-g groupId] -a artifactId [-v version] [-o] [-- mvnOpts ...]
echo @ http://www.ops4j.org/projects/pax/construct/help/import-bundle.html
...
@echo on
mvn -N %PAX_PLUGIN%:import-bundle -DgroupId=%_GROUPID_% -DartifactId=%_ARTIFACTID_% -Dversion=%_VERSION_% %_EXTRA_%
:done
